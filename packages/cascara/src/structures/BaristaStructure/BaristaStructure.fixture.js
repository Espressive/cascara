...
export default {
  components: (
    <BaristaStructure
      detail={<BaristaStructure.Detail header='Detail' />}
      header={<BaristaStructure.Header title='Cool Company' />}
      list={<BaristaStructure.List header='List' />}
      nav={<BaristaStructure.Nav linkComponent={NavLink} links={links} />}
    />
  ),
  loading: (
    <BaristaStructure
      detail={<BaristaStructure.Detail isLoading />}
      header={<BaristaStructure.Header />}
      list={<BaristaStructure.List isLoading />}
      nav={<BaristaStructure.Nav />}
    />
  ),
  scrolling: (
    <BaristaStructure
