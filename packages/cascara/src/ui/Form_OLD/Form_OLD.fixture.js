...
const BasicForm = (props) => {
  ...
  return (
    <>
      ...
      <FormOld {...props} onAction={handleFormAction} />
    </>
  );
};
...
const DataWithDisplay = (props) => (
  <>
    ...
    <p>A form can not be in an editing state initially.</p>{' '}
    <FormOld {...props} />
  </>
);
...
const InitialEditing = (props) => (
  <>
    <h1>Initial Editing FormOld</h1>{' '}
    <p>A form can be in an editing state initially.</p> <FormOld {...props} />
  </>
);
...
const EmptyForm = (props) => (
  <>
    ...
    <p>
      ...
      FormOld component will notify there is not data to present.
    </p>
    <FormOld {...props} />
  </>
);
