...
**Item deletion**:
Some tables allow the user to delete record via a button displayed at the row level.
...
| ------- | ------------- | ------- | -------------------------------------------------- |
| Bulk    | Boolean       | `FALSE` | If true, activates the bulk mode (multi-select)    |
...
| Attribute  | Type                                                                   | default    | Description                                              |
| ---------- | ---------------------------------------------------------------------- | ---------- | -------------------------------------------------------- |
| accessor   | String                                                                 | `null`     | The name of the entity attribute that maps to the column |
...
| label      | String                                                                 | `''`       | The text to display as column header                     |
