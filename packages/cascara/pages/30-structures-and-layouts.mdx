...
<img src='/structure.svg' alt='Structure' className='right' />
...
<img src='/layout.svg' alt='Layout' className='right' />
...
<Rule
  title='A Rule'
  body='Do not do any bad things here or else we will cut you.'
  doImg='https://placedog.net/500/500?id=1'
  dontImg='https://placedog.net/500/500?id=2'
/>
