...
var Clickable = require('reakit/Clickable');
...
require('@fluentui/react-icons-northstar');
...
var propTypes$5 = {
  children: pt__default['default'].oneOfType([pt__default['default'].node, pt__default['default'].array]),
  isEditing: pt__default['default'].bool,
  record: pt__default['default'].shape({})
};
...
var ModuleSandbox = function ModuleSandbox(_ref) {
  ...
  var enterEditMode = React.useCallback(function () {
    if (!(state !== null && state !== void 0 && state.isEditing)) {
      setState(_extends__default['default']({}, state, {
        isEditing: true
      }));
    }
  }, [state, setState]);
  var exitEditMode = React.useCallback(function () {
    if (state !== null && state !== void 0 && state.isEditing) {
      setState(_extends__default['default']({}, state, {
        isEditing: false
      }));
  ...
  var onAction = React.useCallback(function (action, record) {
    // eslint-disable-next-line no-console -- we need this as a developer message
    console.log('Action invoked: ', action === null || action === void 0 ? void 0 : action.name, record);
  }, []);
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.ModuleProvider, {
    value: _extends__default['default']({}, state, {
...
var cx$1 = classNames__default['default'].bind(styles$1);
var propTypes$4 = {
  children: pt__default['default'].oneOfType([pt__default['default'].arrayOf(pt__default['default'].node), pt__default['default'].node]),
  className: pt__default['default'].string,
  trigger: pt__default['default'].node
};
...
var Popover = function Popover(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Popover$1.PopoverDisclosure, _extends__default['default']({}, popover, {
    ref: triggerRef
  }, trigger.props), function (disclosureProps) {
    return /*#__PURE__*/React__default['default'].cloneElement(trigger, disclosureProps);
  }), /*#__PURE__*/React__default['default'].createElement(Popover$1.Popover, _extends__default['default']({
    "aria-label": rest['aria-label'] ? rest['aria-label'] : 'Menu',
    className: cx$1('_', className)
  }, popover, rest), children), /*#__PURE__*/React__default['default'].createElement(Popover$1.PopoverBackdrop, _extends__default['default']({
...
var LOADING_TRIGGER = /*#__PURE__*/React__default['default'].createElement(Button.Button, {
  className: "ui basic loading icon button",
  disabled: true
}, /*#__PURE__*/React__default['default'].createElement(react.InlineIcon, {
  icon: icons.eyeIcon
}));
var STATE_SHAPE = pt__default['default'].exact({
  currentSelection: pt__default['default'].arrayOf(pt__default['default'].object),
  itemAdd: pt__default['default'].func.isRequired,
  itemRemove: pt__default['default'].func.isRequired,
  moveItemDown: pt__default['default'].func.isRequired,
  moveItemUp: pt__default['default'].func.isRequired
});
var VIEW_CONFIG_PROP_TYPES = {
  isInitialOpen: pt__default['default'].bool,
  options: pt__default['default'].arrayOf(pt__default['default'].object).isRequired,
  placement: pt__default['default'].oneOf(['bottom-end', 'bottom-start']),
  state: STATE_SHAPE,
  title: pt__default['default'].string,
  trigger: pt__default['default'].node
};
...
var useViewConfigState = function useViewConfigState(_temp) {
  ...
  var initial = reakitUtils.useInitialValue(lastFilter || initialSelection); // We have a single state that is managed with helper functions
  ...
  var moveItemDown = function moveItemDown(obj) {
    ...
    setCurrentSelectionAndStorage(ramda.insert(newIndex, obj, cleanList));
...
var propTypes$3 = {
  isActive: pt__default['default'].bool,
  itemAdd: pt__default['default'].func.isRequired,
  itemRemove: pt__default['default'].func.isRequired,
  label: pt__default['default'].string.isRequired,
  moveItemDown: pt__default['default'].func.isRequired,
  moveItemUp: pt__default['default'].func.isRequired,
  state: pt__default['default'].shape({
    hide: pt__default['default'].func,
    modal: pt__default['default'].bool,
    placement: pt__default['default'].string,
    preventBodyScroll: pt__default['default']["boolean"],
    unstable_popperModifiers: pt__default['default'].arrayOf(pt__default['default'].shape({
      name: pt__default['default'].string,
      options: pt__default['default'].shape({
        offset: pt__default['default'].func
      })
    }))
  }).isRequired
};
...
var ViewConfigItem = function ViewConfigItem(_ref) {
  ...
  var originalObject = React.useMemo(function () {
    return _extends__default['default']({
      label: label
    }, rest);
  }, [label, rest]);
  var handleItemAdd = React.useCallback(function () {
    itemAdd(originalObject);
  }, [itemAdd, originalObject]);
  var handleItemRemove = React.useCallback(function () {
    itemRemove(originalObject);
  }, [itemRemove, originalObject]);
  var handlemoveItemUp = React.useCallback(function (e) {
    e.stopPropagation();
    moveItemUp(originalObject);
  }, [moveItemUp, originalObject]);
  var handlemoveItemDown = React.useCallback(function (e) {
    e.stopPropagation();
    moveItemDown(originalObject);
  }, [moveItemDown, originalObject]);
  return /*#__PURE__*/React__default['default'].createElement(Menu.MenuItem, _extends__default['default']({}, state, {
    as: "div",
  ...
  }, label), isActive && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles.MoveButtons
  }, /*#__PURE__*/React__default['default'].createElement(DataUrl.Button, {
    "aria-label": "Move up",
...
var MemoViewConfigItem = /*#__PURE__*/React.memo(ViewConfigItem);
...
var ViewConfig$1 = function ViewConfig(_ref) {
  ...
  var menuState = Menu.useMenuState({
    ...
    unstable_popperModifiers: DataUrl.DEFAULT_CASCARA_MODIFIERS,
  ...
  var filteredInactiveOptions = ramda.compose(ramda.without(activeOptions), ramda.filter(hasMatch))(options);

  var renderOptions = function renderOptions(options, isSelected) {
    return options.map(function (option) {
      state.currentSelection;
          var setterFunctions = _objectWithoutPropertiesLoose__default['default'](state, _excluded);

      return /*#__PURE__*/React__default['default'].createElement(MemoViewConfigItem, _extends__default['default']({}, option, setterFunctions, {
        isActive: isSelected,
        key: option.label,
        state: menuState
      }));
  ...
  var handleSearchValue = React.useCallback(function (e) {
  ...
  return options ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Menu.MenuButton, _extends__default['default']({}, menuState, trigger.props, {
    ref: triggerRef
  ...
  }, title), activeOptions.length > 0 && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles.ActiveItems
  }, renderOptions(activeOptions, true)), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "ui icon input"
  }, searchValue && /*#__PURE__*/React__default['default'].createElement(Clickable.Clickable, {
    as: "i",
    ...
    type: "search",
    value: searchValue
  })), filteredInactiveOptions.length > 0 ? renderOptions(filteredInactiveOptions) : /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles.Info
  }, searchValue ? /*#__PURE__*/React__default['default'].createElement("em", null, "No results") : /*#__PURE__*/React__default['default'].createElement("em", null, "All selected"))))) : null;
};
...
var ViewConfig = function ViewConfig(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, options ? /*#__PURE__*/React__default['default'].createElement(ViewConfig$1, props) : LOADING_TRIGGER);
};
...
var propTypes = {
  ...
  cancelLabel: pt__default['default'].node,

  /** An optional text label for the edit button */
  editLabel: pt__default['default'].node,

  /** An optional text label for the save button */
  saveLabel: pt__default['default'].node
};
...
exports.ActionButton = DataUrl.ActionButton;
exports.ActionEdit = DataUrl.ActionEdit;
exports.ChatProvider = DataUrl.ChatProvider;
exports.DataCheckbox = DataUrl.DataCheckbox;
exports.DataColor = DataUrl.DataColor;
exports.DataDate = DataUrl.DataDate;
exports.DataDateTime = DataUrl.DataDateTime;
exports.DataEmail = DataUrl.DataEmail;
exports.DataFile = DataUrl.DataFile;
exports.DataImage = DataUrl.DataImage;
exports.DataJson = DataUrl.DataJson;
exports.DataMonth = DataUrl.DataMonth;
exports.DataNumber = DataUrl.DataNumber;
exports.DataPassword = DataUrl.DataPassword;
exports.DataRadio = DataUrl.DataRadio;
exports.DataRange = DataUrl.DataRange;
exports.DataSelect = DataUrl.DataSelect;
exports.DataTel = DataUrl.DataTel;
exports.DataText = DataUrl.DataText;
exports.DataTextArea = DataUrl.DataTextArea;
exports.DataTime = DataUrl.DataTime;
exports.DataUrl = DataUrl.DataUrl;
exports.DataWeek = DataUrl.DataWeek;
exports.Loader = DataUrl.Loader;
exports.ModuleContext = DataUrl.ModuleContext;
exports.ModuleError = DataUrl.ModuleError;
exports.ModuleProvider = DataUrl.ModuleProvider;
exports.getStatusFromDataLength = DataUrl.getStatusFromDataLength;
exports.useDeveloperMessage = DataUrl.useDeveloperMessage;
exports.useMediaQuery = DataUrl.useMediaQuery;
exports.useToggle = DataUrl.useToggle;
exports.ActionEditTable = ActionEdit;
exports.ModuleSandbox = ModuleSandbox;
exports.Popover = Popover;
exports.ViewConfig = ViewConfig;
exports.useBoolean = useBoolean;
exports.useViewConfigState = useViewConfigState;
