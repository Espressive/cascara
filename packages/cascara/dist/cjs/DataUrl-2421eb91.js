...
var cx$1 = classNames__default['default'];
var propTypes$s = {
  /** Can render as a different tag or component */
  as: pt__default['default'].oneOfType([pt__default['default'].string, pt__default['default'].elementType]),

  /** Main content of the button */
  content: pt__default['default'].string,
  ...
  icon: pt__default['default'].shape({}),

  /** Sets the color type of the button to follow the theme brand color */
  isBrandColor: pt__default['default'].bool,

  /** Indicates the outcome of clicking the button ('positive', 'negative') */
  outcome: pt__default['default'].oneOf(['positive', 'negative']),

  /** A button can have multiple sizes */
  size: pt__default['default'].oneOf(['small', 'regular', 'large'])
...
var Button = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(reakit.Button, _extends__default['default']({}, rest, {
    as: as,
    className: legacyClassname,
    ref: ref,
    rel: getSafeLinkRel(rest)
  }), icon ? /*#__PURE__*/React__default['default'].createElement(react.InlineIcon, {
    icon: icon
  }) : buttonText);
});
...
var useMediaQuery = function useMediaQuery(query, ifTrueFunc, ifFalseFunc) {
  ...
  var _useState = React.useState(Boolean(mediaQuery === null || mediaQuery === void 0 ? void 0 : mediaQuery.matches)),
      match = _useState[0],
...
var propTypes$r = {
  ...
  error: pt__default$1['default'].object,
  resetErrorBoundary: pt__default$1['default'].func
};
...
var ErrorFallback = function ErrorFallback(_ref) {
  ...
  var handleTryAgain = React.useCallback(function () {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: "header"
  }, "Something went wrong:"), showError && /*#__PURE__*/React__default['default'].createElement("p", null, /*#__PURE__*/React__default['default'].createElement("pre", null, error === null || error === void 0 ? void 0 : error.message)), /*#__PURE__*/React__default['default'].createElement(Button, {
...
var Boundaries = function Boundaries(_ref) {
  ...
  if (isDOM) {
    return /*#__PURE__*/React__default['default'].createElement(React.Suspense, {
      fallback: /*#__PURE__*/React__default['default'].createElement(SuspenseComponent, null)
...
var DEFAULT_CASCARA_MODIFIERS = [popperOverTrigger, maxSize__default['default'], applyMaxSize];
...
var TEAMS_THEMES = {
  teamsDarkTheme: reactNorthstar.teamsDarkTheme,
  teamsHighContrastTheme: reactNorthstar.teamsHighContrastTheme,
  teamsTheme: reactNorthstar.teamsTheme
};
...
var teamsThemeOverrides = function teamsThemeOverrides(teamsThemeName) {
  ...
  var theme = _extends__default['default']({}, TEAMS_THEMES[teamsThemeName], {
    componentStyles: _extends__default['default']({}, TEAMS_THEMES[teamsThemeName].componentStyles, {
      Chat: styles$4.mergeComponentStyles(TEAMS_THEMES[teamsThemeName].componentStyles.Chat, chatStyles$2)
    }),
...
var fontFaces = [].concat(reactNorthstar.teamsTheme.fontFaces, fontFaces$1);

var siteVariables$1 = _extends__default['default']({}, reactNorthstar.teamsTheme.siteVariables, {
...
var getBorderFocusStyles = function getBorderFocusStyles(args) {
  ...
  return {
    ...
    ':focus-visible': {
      ...
      ':before': _extends__default['default']({}, defaultPreudoStyles, {
      ...
      ':after': _extends__default['default']({}, defaultPreudoStyles, {
        zIndex: sv.zIndexes.foreground,
...
var getIconFillOrOutlineStyles = function getIconFillOrOutlineStyles(_ref) {
  ...
  return _ref2 = {}, _ref2["& ." + reactIconsNorthstar.iconClassNames.filled] = {
    display: outline ? 'none' : 'block'
  }, _ref2["& ." + reactIconsNorthstar.iconClassNames.outline] = {
...
var pickValuesFromColorScheme = function pickValuesFromColorScheme(colorScheme, componentAreas) {
  ...
  Object.keys(colorScheme).forEach(function (color) {
    ...
    var colorValues = componentAreas.reduce(function (accumulator, area) {
      ...
      return _extends__default['default']({}, accumulator, (_extends3 = {}, _extends3[area] = colorScheme[color][area], _extends3));
    }, {});
    result = _extends__default['default']({}, result, (_extends4 = {}, _extends4[color] = colorValues, _extends4));
  });
  return result;
};
...
var attachmentStyles$1 = {
  root: function root(_ref) {
    ...
    return _extends__default['default']({
      ...
      cursor: 'pointer',
      ':focus-visible': _extends__default['default']({}, borderFocusStyles[':focus-visible'], (_extends2 = {
        backgroundColor: v.focusBackgroundColor,
        color: v.focusColor
      }, _extends2["& ." + reactNorthstar.attachmentActionClassName] = {
        color: v.focusColor
      }, _extends2["& ." + reactIconsNorthstar.svgIconClassName] = {
        color: v.focusColor
      }, _extends2)),
      ':hover': (_hover = {
        backgroundColor: v.backgroundColorHover,
        color: v.textColorHover
      }, _hover["& ." + reactNorthstar.attachmentActionClassName] = {
        color: v.textColorHover
      }, _hover["& ." + reactIconsNorthstar.svgIconClassName] = {
        color: v.textColorHover
      }, _hover)
    });
  }
...
var attachmentActionStyles$1 = {
  root: function root(_ref) {
    ...
    return _extends__default['default']({
      ...
      ':focus-visible': _extends__default['default']({}, iconFilledStyles, borderFocusStyles[':focus-visible'])
    }, p.primary && {
      ...
      ':hover': _extends__default['default']({}, getIconFillOrOutlineStyles({
        outline: false
      }))
    });
  },
  icon: function icon(_ref2) {
    ...
    return _extends__default['default']({
      ...
      opacity: 0,
      width: 0
    }, p.hasContent && _extends__default['default']({
  ...
  loader: function loader(_ref3) {
    ...
    var p = _ref3.props,
        v = _ref3.variables;
    return _extends__default['default']((_extends2 = {}, _extends2["& ." + reactNorthstar.loaderSlotClassNames.indicator] = {
      width: v.actionLoaderSize,
      height: v.actionLoaderSize
    }, _extends2["& ." + reactNorthstar.loaderSlotClassNames.svg] = {
      ':before': {
        animationName: {
          to: {
...
var attachmentIconStyles$1 = {
  root: function root(_ref) {
    ...
    }, _ref2["& ." + reactIconsNorthstar.svgIconClassName] = {
      height: '100%',
      width: '100%',
      '& svg': {
        height: '100%',
...
var buttonStyles$1 = {
  root: function root(_ref) {
    ...
    var borderFocusStyles = getBorderFocusStyles(_extends__default['default']({
      variables: siteVariables,
    ...
    return _extends__default['default']({
      height: v.height,
      minWidth: ramda.isNil(p.loading) ? v.minWidth : v.loadingMinWidth,
      maxWidth: v.maxWidth,
      color: v.color,
    ...
    }, !p.text && _extends__default['default']({
      outline: 0,
      ...
      ':focus-visible': _extends__default['default']({}, borderFocusStyles[':focus-visible'], {
      ...
      boxShadow: 'none'
    }), p.circular && !p.text && _extends__default['default']({
      minWidth: v.height,
      padding: 0,
    ...
    }), p.primary && !p.text && _extends__default['default']({
    ...
    }), p.inverted && _extends__default['default']({
      ...
      ':focus': _extends__default['default']({}, borderFocusStyles[':focus'], {
        boxShadow: 'none'
      }),
      ':focus-visible': _extends__default['default']({}, borderFocusStyles[':focus-visible'], !p.disabledFocusable && {
        backgroundColor: siteVariables.colorScheme.silver.backgroundPressed,
        color: siteVariables.colorScheme.silver.foregroundHover
      })
    }), p.tinted && _extends__default['default']({
      ...
      pointerEvents: 'none'
    }, (p.disabled || p.disabledFocusable) && _extends__default['default']({
      cursor: 'default',
      ...
      width: '100%',
      maxWidth: '100%'
    }, p.iconOnly && _extends__default['default']({
      minWidth: v.height,
      padding: 0
    }, !p.inverted && {
      ':hover': _extends__default['default']({}, getIconFillOrOutlineStyles({
...
var buttonGroupStyles$1 = {
  ...
  middleButton: function middleButton(_ref) {
    var p = _ref.props;
    return _extends__default['default']({}, commonButtonsStyles$1(p.circular));
  },
  firstButton: function firstButton(_ref2) {
    var p = _ref2.props,
        v = _ref2.variables;
    return _extends__default['default']({}, commonButtonsStyles$1(p.circular), !p.circular && {
...
var chatItemStyles$1 = {
  ...
  gutter: function gutter(_ref2) {
    ...
    var p = _ref2.props,
        v = _ref2.variables;
    return _extends__default['default']((_extends2 = {
      position: 'absolute',
...
var chatMessageStyles$1 = {
  root: function root(_ref5) {
    ...
    return _extends__default['default']({
      ...
      variables: siteVariables
    }), ramda.isNil(v.showActionMenu) && {
      ':hover': (_hover = {}, _hover["> ." + reactNorthstar.chatMessageSlotClassNames.actionMenu] = {
        opacity: 1,
  ...
  actionMenu: function actionMenu(_ref6) {
    ...
    return _extends__default['default']({
      ...
      zIndex: p.focused || !ramda.isNil(v.showActionMenu) ? v.overlayZIndex : -1
    }, ramda.isNil(v.showActionMenu) && {
  ...
  author: function author(_ref7) {
    var p = _ref7.props,
        v = _ref7.variables;
    return _extends__default['default']({}, (p.mine || p.attached === 'bottom' || p.attached === true) && screenReaderContainerStyles, {
      color: v.authorColor,
...
var chatMessageReadStatusStyles$1 = {
  root: function root(_ref) {
    ...
    return {
      ...
      ':after': _extends__default['default']({
        content: "\"" + p.title + "\""
...
var beforeAndAfter$1 = function beforeAndAfter(size, variables, colors, props) {
  return _extends__default['default']({
    ...
    background: ramda.pathOr(variables.dividerColor, 'foreground', colors)
  });
};
...
var dividerStyles$1 = {
  root: function root(_ref) {
    ...
    return _extends__default['default']({
      color: ramda.pathOr(variables.textColor, 'foreground', colors),
      display: 'flex',
      alignItems: 'center'
    }, !fitted && {
      ...
      '::before': _extends__default['default']({}, beforeAndAfter$1(size, variables, colors, props)),
      '::after': _extends__default['default']({}, beforeAndAfter$1(size, variables, colors, props))
    } : {
      '::before': _extends__default['default']({}, beforeAndAfter$1(size, variables, colors, props))
    });
  }
...
var transparentColorStyleObj$1 = _extends__default['default']({}, transparentColorStyle$1, {
  ':hover': transparentColorStyle$1,
  ':active': transparentColorStyle$1,
  ':focus': _extends__default['default']({}, transparentColorStyle$1, {
    ':active': transparentColorStyle$1
  })
});
...
var dropdownStyles$1 = {
  root: function root(_ref) {
    var p = _ref.props;
    return _extends__default['default']({}, p.inline && {
      display: 'inline-flex'
    });
  },
  ...
  container: function container(_ref3) {
    ...
    }, p.focused && _extends__default['default']({
      backgroundColor: v.backgroundColor
    }, p.search && {
      borderBottomColor: v.borderColorFocus
    }, !p.search && !p.open && p.isFromKeyboard && getBorderFocusStyles({
      variables: siteVariables
    })[':focus-visible']), p.inline && _extends__default['default']({}, transparentColorStyleObj$1, {
      alignItems: 'center'
    }), p.inverted && {
    ...
    }, (_extends2 = {}, _extends2["& ." + reactNorthstar.dropdownSlotClassNames.triggerButton] = _extends__default['default']({}, p.disabled && {
  ...
  triggerButton: function triggerButton(_ref5) {
    ...
    return _extends__default['default']({
    ...
    }, p.multiple && _extends__default['default']({
      minWidth: 0,
      flex: 1
    }, p.hasItemsSelected && {
      position: 'absolute',
      ...
      ':hover': _extends__default['default']({}, transparentColorStyle$1, {
...
var dropdownSelectedItemStyles$1 = {
  root: function root(_ref) {
    ...
    return _extends__default['default']({
      ...
      }, _hover["& ." + reactNorthstar.dropdownSelectedItemSlotClassNames.icon] = {
  ...
  header: function header(_ref2) {
    var p = _ref2.props;
        _ref2.variables;
    return _extends__default['default']({}, p.hasImage && {
...
var dropdownItemStyles$1 = {
  root: function root(_ref) {
    ...
    return _extends__default['default']({
      ...
      position: 'relative'
    }, p.active && _extends__default['default']({}, p.isFromKeyboard && getBorderFocusStyles({
      variables: siteVariables,
      borderRadius: 0
    })[':focus-visible'], !p.isFromKeyboard && _extends__default['default']({
      color: v.listItemColorHover,
      backgroundColor: v.listItemBackgroundColorHover
    }, p.hasHeader && (_ref2 = {}, _ref2["& ." + reactNorthstar.dropdownItemSlotClassNames.header] = {
      color: v.listItemColorHover
    }, _ref2), p.hasContent && (_ref3 = {}, _ref3["& ." + reactNorthstar.dropdownItemSlotClassNames.content] = {
      color: v.listItemColorHover
    }, _ref3))));
  },
  image: function image() {
...
var inputStyles$1 = {
  ...
  input: function input(_ref2) {
    ...
    return _extends__default['default']({
      ...
      '::placeholder': _extends__default['default']({
        color: v.placeholderColor,
        opacity: 1
      }, p.disabled && {
        color: v.colorDisabled
      }),
      ':focus': _extends__default['default']({}, !p.error && {
  ...
  icon: function icon(_ref3) {
    ...
    return _extends__default['default']({
      ...
      right: v.iconRight
    }, p.clearable && p.hasValue && _extends__default['default']({
      height: '100%',
      width: pxToRem(16),
      color: v.iconColor
    }, p.disabled && {
...
var inputLabelStyles$1 = {
  root: function root(_ref) {
    ...
    }, p.labelPosition === 'inside' && _extends__default['default']({
...
var radioGroupItemStyles$1 = {
  root: function root(_ref) {
    ...
    return _extends__default['default']({
      ...
      }, _hover["& ." + reactNorthstar.radioGroupItemSlotClassNames.indicator] = _extends__default['default']({
    ...
    }, p.checked && _extends__default['default']({}, restHoverFocusTextColor$1(v.textColorChecked)), p.disabled && _extends__default['default']({}, restHoverFocusTextColor$1(v.colorDisabled)), getBorderFocusStyles({
      variables: siteVariables
    }));
  },
...
var mergedComponentStyles$1 = _extends__default['default']({}, Object.fromEntries(COPY_COMPONENTS$1.map(function (component) {
  return [component, reactNorthstar.teamsTheme.componentStyles[component]];
})), componentStyles$1); // console.log(mergedComponentStyles);


var mergedComponentVariables$1 = _extends__default['default']({}, Object.fromEntries(COPY_COMPONENTS$1.map(function (component) {
  return [component, reactNorthstar.teamsTheme.componentVariables[component]];
})), componentVariables$1); // console.log(mergedComponentVariables);


var barista$1 = styles$4.createTheme({
...
var siteVariables = _extends__default['default']({}, reactNorthstar.teamsTheme.siteVariables, {
...
var buttonGroupStyles = {
  ...
  middleButton: function middleButton(_ref) {
    var p = _ref.props;
    return _extends__default['default']({}, commonButtonsStyles(p.circular));
  },
  firstButton: function firstButton(_ref2) {
    var p = _ref2.props,
        v = _ref2.variables;
    return _extends__default['default']({}, commonButtonsStyles(p.circular), !p.circular && {
      borderTopLeftRadius: v.borderRadius,
      borderBottomLeftRadius: v.borderRadius
    });
  },
...
var chatMessageStyles = {
  ...
  author: function author(_ref3) {
    var p = _ref3.props,
        v = _ref3.variables;
    return _extends__default['default']({}, (p.attached === 'bottom' || p.attached === true) && screenReaderContainerStyles, {
      color: v.authorColor,
      marginRight: v.authorMarginRight,
      fontWeight: v.authorFontWeight,
      fontSize: '1rem'
...
var dividerStyles = {
  root: function root(_ref) {
    ...
    return _extends__default['default']({
      ...
      fontSize: pxToRem(12 + size),
      lineHeight: variables.textLineHeight,
      '::before': _extends__default['default']({}, beforeAndAfter(size, variables, colors, props)),
      '::after': _extends__default['default']({}, beforeAndAfter(size, variables, colors, props))
    } : {
      '::before': _extends__default['default']({}, beforeAndAfter(size, variables, colors, props))
    });
  }
...
var transparentColorStyleObj = _extends__default['default']({}, transparentColorStyle, {
  ':hover': transparentColorStyle,
  ':active': transparentColorStyle,
  ':focus': _extends__default['default']({}, transparentColorStyle, {
    ':active': transparentColorStyle
  })
});
...
var dropdownStyles = {
  ...
  container: function container(_ref3) {
    ...
    return _extends__default['default']({
      ...
      variables: siteVariables
    })[':focus-visible']), p.inline && _extends__default['default']({}, transparentColorStyleObj, {
      alignItems: 'center'
    }), p.inverted && {
      backgroundColor: v.invertedBackgroundColor,
      ':hover': {
  ...
  triggerButton: function triggerButton(_ref5) {
    ...
    return _extends__default['default']({
      ...
      ':hover': _extends__default['default']({}, transparentColorStyle, {
        color: v.color // required for HC theme
...
var radioGroupItemStyles = {
  root: function root(_ref) {
    ...
    }, p.checked && _extends__default['default']({}, restHoverFocusTextColor(v.textColorChecked)), p.disabled && _extends__default['default']({}, restHoverFocusTextColor(v.colorDisabled)), getBorderFocusStyles({
      variables: siteVariables
    }));
  },
  indicator: function indicator(_ref2) {
...
var mergedComponentStyles = _extends__default['default']({}, Object.fromEntries(COPY_COMPONENTS.map(function (component) {
  return [component, reactNorthstar.teamsTheme.componentStyles[component]];
})), componentStyles); // console.log(mergedComponentStyles);


var mergedComponentVariables = _extends__default['default']({}, Object.fromEntries(COPY_COMPONENTS.map(function (component) {
  return [component, reactNorthstar.teamsTheme.componentVariables[component]];
})), componentVariables); // console.log(mergedComponentVariables);


var barista = styles$4.createTheme({
...
var propTypes$p = {
  ...
  inputComponent: pt__default$1['default'].node,
  isThemeSelectable: pt__default$1['default'].bool
};
...
var ChatProvider = function ChatProvider(_ref) {
  ...
  var _useState = React.useState(items[DEFAULT_THEME_INDEX].value),
      theme = _useState[0],
      setTheme = _useState[1];

  var handleDropdownChange = React.useCallback(function (e, data) {
    setTheme(data.value.value);
  }, [setTheme]); // console.log(themes[theme].staticStyles);

  return /*#__PURE__*/React__default['default'].createElement(Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Provider, {
    overwrite: true,
    theme: themes[theme]
  ...
  }, isThemeSelectable && /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Dropdown, {
...
var ModuleContext = /*#__PURE__*/React.createContext(defaultValue); // We are also exporting the default value in case we need to hydrate or merge

var _excluded$m = ["children", "value"];
var propTypes$o = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].node, pt__default$1['default'].arrayOf(pt__default$1['default'].node)]),
  value: pt__default$1['default'].shape({
    isEditing: pt__default$1['default'].bool
  })
};
...
var ModuleProvider = function ModuleProvider(_ref) {
  var children = _ref.children,
      value = _ref.value,
      props = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$m);
  ...
  var mergedValues = _extends__default['default']({}, defaultValue, {
    isEditing: isEditing,
    setIsEditing: setIsEditing
  }, value);

  return /*#__PURE__*/React__default['default'].createElement(ModuleContext.Provider, _extends__default['default']({
    value: mergedValues
  }, props), children);
};
...
var propTypes$n = {
  moduleName: pt__default$1['default'].string.isRequired,
  moduleOptions: pt__default$1['default'].arrayOf(pt__default$1['default'].object).isRequired
};
var cx = classNames__default$1['default'].bind(styles);
...
var ActionButton = function ActionButton(_ref) {
  var actionName = _ref.actionName,
      ...
      _ref.isLabeled;
      var rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$k);

  var _useContext = React.useContext(ModuleContext),
  ...
  var label = rest.label,
      restWithoutLabel = _objectWithoutPropertiesLoose__default['default'](rest, _excluded2); //
  ...
  var handleClick = React.useCallback(function (_ref2) {
    var currentTarget = _ref2.currentTarget;
    onAction && onAction(currentTarget, record || data);
  }, [data, onAction, record]);
  return isEditing ? null : /*#__PURE__*/React__default['default'].createElement(reakit.Button, _extends__default['default']({}, restWithoutLabel, {
    "aria-label": label,
...
var propTypes$l = {
  ...
  cancelLabel: pt__default$1['default'].node,

  /** An optional text label for the edit button */
  editLabel: pt__default$1['default'].node,

  /** An optional text label for the save button */
  saveLabel: pt__default$1['default'].node
};
var DEFAULT_EDIT = /*#__PURE__*/React__default['default'].createElement(react.InlineIcon, {
  icon: icons.pencilIcon
});
var DEFAULT_CANCEL = /*#__PURE__*/React__default['default'].createElement(react.InlineIcon, {
  icon: icons.closeIcon
});
var DEFAULT_SAVE = /*#__PURE__*/React__default['default'].createElement(react.InlineIcon, {
...
var ActionEdit = function ActionEdit(_ref) {
  ...
  var handleReset = React.useCallback(function () {
    if (typeof onAction === 'function') {
      ...
      {
        name: 'edit.cancel'
      }, _extends__default['default']({}, record));
    }
  ...
  var handleEdit = React.useCallback(function () {
    ...
    reset(_extends__default['default']({}, record));
  ...
  var onSubmit = React.useCallback(function (data) {
    if (typeof onAction === 'function') {
      ...
      {
        name: 'edit.save'
      }, _extends__default['default']({}, record, data));
    }
  ...
  return isEditing ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(reakit.Button, {
    ...
    type: "button"
  }, cancelLabel), /*#__PURE__*/React__default['default'].createElement(reakit.Button, {
    "aria-label": "Save",
    ...
    type: "button"
  }, saveLabel)) : /*#__PURE__*/React__default['default'].createElement(reakit.Button, {
    "aria-label": "Edit",
...
var ModuleErrorBoundary = function ModuleErrorBoundary(_ref) {
  var children = _ref.children;
  return /*#__PURE__*/React__default['default'].createElement(Boundaries, {
...
var propTypes$j = {
  ...
  attribute: pt__default$1['default'].string,
  ...
  value: pt__default$1['default'].string
};
...
var DataColor = function DataColor(_ref) {
  ...
  var renderEditing = /*#__PURE__*/React__default['default'].createElement("label", {
    htmlFor: setHtmlFor
  }, label && isLabeled && /*#__PURE__*/React__default['default'].createElement("span", {
    className: styles.LabelText
  }, label), /*#__PURE__*/React__default['default'].createElement(Input.Input, _extends__default['default']({}, rest, {
  ...
  var renderDisplay = /*#__PURE__*/React__default['default'].createElement("span", null, label && isLabeled && /*#__PURE__*/React__default['default'].createElement("span", {
    className: styles.LabelText
  }, label), /*#__PURE__*/React__default['default'].createElement("span", _extends__default['default']({
    "aria-label": label,
    className: styles.Color
  }, rest), value)); // Do not render an editable input if the module is not editable

  return /*#__PURE__*/React__default['default'].createElement(ModuleErrorBoundary, null, /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles.Color
...
var propTypes$i = {
  ...
  /** A Module can have a value */
  value: pt__default$1['default'].bool
};
...
var DataCheckbox = function DataCheckbox(_ref) {
  ...
  var checkbox = Checkbox.useCheckboxState({
    state: Boolean(value)
  });
  var renderEditing = /*#__PURE__*/React__default['default'].createElement("label", {
    htmlFor: setHtmlFor
  }, /*#__PURE__*/React__default['default'].createElement(Checkbox.Checkbox, _extends__default['default']({}, rest, checkbox, {
    "aria-label": setAriaLabel,
  ...
  var renderDisplay = /*#__PURE__*/React__default['default'].createElement("span", null, /*#__PURE__*/React__default['default'].createElement("span", _extends__default['default']({
    className: styles.Input,
    "data-checked": value ? true : undefined
  }, rest), value), label && isLabeled && /*#__PURE__*/React__default['default'].createElement("span", {
    className: styles.LabelText
...
var DataEmail = function DataEmail(_ref) {
  var attribute = _ref.attribute,
      ...
      label = _ref.label,
      value = _ref.value,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$f);
...
var propTypes$d = {
  ...
  /** Image path */
  src: pt__default$1['default'].string,
...
var propTypes$c = {
  ...
  /** A Module can have a value */
  value: pt__default$1['default'].oneOfType([pt__default$1['default'].object, pt__default$1['default'].array, pt__default$1['default'].string])
};
...
var DataJson = function DataJson(_ref) {
  ...
  var renderEditing = /*#__PURE__*/React__default['default'].createElement("label", {
    ...
    as: TextareaAutosize__default['default'],
    className: styles.Input,
...
var DataMonth = function DataMonth(_ref) {
  var attribute = _ref.attribute,
      ...
      label = _ref.label,
      value = _ref.value,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$b);
...
var propTypes$a = {
  ...
  /** A Module can have a value */
  value: pt__default$1['default'].number
};
...
var DataRadio = function DataRadio(_ref) {
  ...
  var renderRadio = function renderRadio(option) {
    return /*#__PURE__*/React__default['default'].createElement("label", {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(Radio.Radio, _extends__default['default']({}, radio, {
      className: styles.Input,
      id: option.label,
      name: option.label,
      ref: formMethods === null || formMethods === void 0 ? void 0 : formMethods.register,
      type: "radio",
      value: option.label
    })), option.label && isLabeled && /*#__PURE__*/React__default['default'].createElement("span", {
      className: styles.LabelText
    }, option.label));
  };

  var renderEditing = /*#__PURE__*/React__default['default'].createElement(Radio.RadioGroup, _extends__default['default']({}, radio, rest, {
    "aria-label": "fruits",
    className: styles.Radio
  }), options ? options.map(function (option) {
    return renderRadio(option);
  }) : renderRadio(value));
  var renderDisplay = /*#__PURE__*/React__default['default'].createElement(ModuleErrorBoundary, null, /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles.Radio
  }, /*#__PURE__*/React__default['default'].createElement("span", null, /*#__PURE__*/React__default['default'].createElement("span", _extends__default['default']({
    className: styles.Input
  }, rest), value), label && isLabeled && /*#__PURE__*/React__default['default'].createElement("span", {
    className: styles.LabelText
  }, label)))); // Do not render an editable input if the module is not editable
...
var propTypes$6 = {
  ...
  options: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
    key: pt__default$1['default'].string,
    text: pt__default$1['default'].oneOfType([pt__default$1['default'].string, pt__default$1['default'].number]),
    value: pt__default$1['default'].oneOfType([pt__default$1['default'].string, pt__default$1['default'].number])
  })),
...
var DataTel = function DataTel(_ref) {
  var attribute = _ref.attribute,
      ...
      label = _ref.label,
      value = _ref.value,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$5);
...
exports.DEFAULT_CASCARA_MODIFIERS = DEFAULT_CASCARA_MODIFIERS;
exports.DataCheckbox = DataCheckbox;
exports.DataColor = DataColor;
exports.DataDate = DataDate;
exports.DataDateTime = DataDateTime;
exports.DataEmail = DataEmail;
...
exports.DataPassword = DataPassword;
exports.DataRadio = DataRadio;
exports.DataRange = DataRange;
exports.DataSelect = DataSelect;
exports.DataTel = DataTel;
exports.DataText = DataText;
exports.DataTextArea = DataTextArea;
exports.DataTime = DataTime;
exports.DataUrl = DataUrl;
exports.DataWeek = DataWeek;
exports.Loader = Loader;
exports.ModuleContext = ModuleContext;
exports.ModuleError = ModuleError;
exports.ModuleProvider = ModuleProvider;
exports.getStatusFromDataLength = getStatusFromDataLength;
exports.popperOverTrigger = popperOverTrigger;
exports.propTypes = propTypes$m;
exports.styleInject = styleInject;
exports.styles = styles$1;
exports.useDeveloperMessage = useDeveloperMessage;
exports.useMediaQuery = useMediaQuery;
exports.useToggle = useToggle;
//# sourceMappingURL=DataUrl-2421eb91.js.map
