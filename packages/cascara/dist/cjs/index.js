...
var DataUrl = require('./DataUrl-2421eb91.js');
var _extends = require('@babel/runtime/helpers/extends');
var _objectWithoutPropertiesLoose = require('@babel/runtime/helpers/objectWithoutPropertiesLoose');
var React = require('react');
var classNames = require('classnames/bind');
var pt = require('@espressive/prop-types');
var Role = require('reakit/Role');
var pt$1 = require('prop-types');
var Color = require('color');
var colorString = require('color-string');
var reakit = require('reakit');
var compare = require('react-fast-compare');
var icons = require('@espressive/icons');
var react = require('@iconify/react');
var Button = require('reakit/Button');
var Menu = require('reakit/Menu');
var reactNorthstar = require('@fluentui/react-northstar');
var reactIconsNorthstar = require('@fluentui/react-icons-northstar');
var memoizeOne = require('memoize-one');
var bar = require('@nivo/bar');
var Popover = require('reakit/Popover');
var circlePacking = require('@nivo/circle-packing');
...
var pt__default = /*#__PURE__*/_interopDefaultLegacy(pt);
var pt__default$1 = /*#__PURE__*/_interopDefaultLegacy(pt$1);
...
var classNames__default$1 = /*#__PURE__*/_interopDefaultLegacy(classNames$1);
...
var FlexItem = function FlexItem(_ref) {
  var children = _ref.children,
      ...
      _ref.shrink;
      var rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$C);
  ...
  var element = isValidElement ? children : /*#__PURE__*/React__default['default'].createElement("div", null, children);
  return /*#__PURE__*/React.cloneElement(element, _extends__default['default']({}, rest, {
    className: classList
  }));
};
...
var cx$d = classNames__default['default'].bind(styles$j);
...
var Flex = function Flex(_ref2) {
  var _ref2$as = _ref2.as,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref2, _excluded$B);

  var classList = cx$d('_', rest.className, _extends__default['default']({
    column: column,
    fluid: fluid
  }, getClassOptions(spaceOptions, space, 'space'), getClassOptions(vAlignOptions, vAlign, 'vAlign')));
  return /*#__PURE__*/React__default['default'].createElement(Role.Role, _extends__default['default']({}, rest, {
    as: as,
    className: classList
  }), children);
};
...
var AdminContext = /*#__PURE__*/React.createContext({
...
var propTypes$16 = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node])
...
var AdminProvider = function AdminProvider(_ref2) {
  ...
  var isSizeMedium = DataUrl.useMediaQuery('(max-width: 768px)');
  var menuDrawer = reakit.useMenuState();
  var menuNav = reakit.useMenuState({
    animated: true,
    orientation: 'vertical',
    unstable_popperModifiers: [noInlineStyles],
    visible: true
  });
  var isSizeSmall = DataUrl.useMediaQuery('(max-width: 320px)', menuNav.hide, menuNav.show);
...
var getColor = function getColor(string) {
  return colorString__default['default'].get(string) ? Color__default['default'](string) : null;
};
...
DataUrl.styleInject(css_248z$i);

var cx$c = classNames__default['default'].bind(styles$i);
var propTypes$15 = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node])
};
...
var AdminStructureChildren = function AdminStructureChildren(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("main", {
    className: cx$c({
      _main: true,
      with_drawer: drawer
    })
  }, children), drawer && /*#__PURE__*/React__default['default'].createElement("section", {
...
var propTypes$14 = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  header: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  nav: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  theme: pt__default$1['default'].shape({
    color: pt__default$1['default'].shape({
      primary: pt__default$1['default'].string,
      secondary: pt__default$1['default'].string
    })
  })
};
...
var AdminStructure = function AdminStructure(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(AdminProvider, null, /*#__PURE__*/React__default['default'].createElement("header", {
    className: styles$i._header
  }, /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, header)), /*#__PURE__*/React__default['default'].createElement("nav", {
    className: styles$i._nav
  }, /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, nav)), /*#__PURE__*/React__default['default'].createElement(AdminStructureChildren, null, /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, children)));
};
...
DataUrl.styleInject(css_248z$h);
...
var useDrawer = function useDrawer(drawer) {
  ...
  var isUpdated = !compare__default['default'](drawer, prevDrawer);
  React.useEffect(function () {
    // Setup
...
var cx$b = classNames__default['default'].bind(styles$h);
var propTypes$13 = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  header: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  isLoading: pt__default$1['default'].bool,
  isPadded: pt__default$1['default'].bool
};
...
var Drawer = function Drawer(_ref) {
  var children = _ref.children,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$A);

  var className = rest.className,
      props = _objectWithoutPropertiesLoose__default['default'](rest, _excluded2$6); // Instead of using the normal return, we put all of our
  // drawer logic here to go into context


  useDrawer( /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement("div", _extends__default['default']({}, props, {
    className: cx$b('Drawer', className, {
      loading: isLoading,
      padded: isPadded
    })
  }), header && /*#__PURE__*/React__default['default'].createElement("h3", {
    className: cx$b('Heading')
  }, header), children, isLoading && !children && /*#__PURE__*/React__default['default'].createElement(DataUrl.Loader, null)))); // We do not want the drawer to actually render anything
...
DataUrl.styleInject(css_248z$g);

var _excluded$z = ["logo", "title", "post"];
var cx$a = classNames__default['default'].bind(styles$g);
var propTypes$12 = {
  logo: pt__default$1['default'].string,
  post: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  title: pt__default$1['default'].string
};
var disabled = false;
...
var Header = function Header(_ref) {
  var logo = _ref.logo,
      title = _ref.title,
      post = _ref.post,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$z);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Flex, _extends__default['default']({}, rest, {
    className: cx$a('Header', rest.className),
    vAlign: "center"
  }), disabled   , /*#__PURE__*/React__default['default'].createElement("a", {
    className: cx$a('Company'),
    href: process.env.PUBLIC_URL || '/'
  }, logo ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(reakit.VisuallyHidden, null, /*#__PURE__*/React__default['default'].createElement("h1", null, title)), /*#__PURE__*/React__default['default'].createElement("img", {
    alt: title,
    className: cx$a('Logo'),
    src: logo
  })) : /*#__PURE__*/React__default['default'].createElement("h1", {
    className: cx$a('Title')
  }, title)), post && /*#__PURE__*/React__default['default'].createElement(Flex.Item, {
    push: true
  }, post), disabled  );
};
...
DataUrl.styleInject(css_248z$f);

var propTypes$11 = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  label: pt__default$1['default'].string.isRequired,
  linkComponent: pt__default$1['default'].shape({
    ...
    render: pt__default$1['default'].func
  }).isRequired,
  // eslint-disable-next-line react/forbid-prop-types -- Could be anything
  linkComponentProps: pt__default$1['default'].object
};
...
var MainTabs = function MainTabs(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(reakit.Tab, _extends__default['default']({
    as: linkComponent,
    className: "item"
...
var cx$9 = classNames__default['default'].bind(styles$f);
var propTypes$10 = {
  as: pt__default$1['default'].string,
  body: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  drawer: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  footer: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  header: pt__default$1['default'].string,
  isLoading: pt__default$1['default'].bool,
  links: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
    // eslint-disable-next-line react/forbid-prop-types -- SVG shows up as an object
    icon: pt__default$1['default'].object,
    label: pt__default$1['default'].string.isRequired,
    linkComponent: pt__default$1['default'].shape({
      // Kind of a hack, but making sure that there is a render function
      // on the link component being passed so we know it is supposed to render
...
var Main = function Main(_ref) {
  var _ref$as = _ref.as,
      ...
      isLoading = _ref$isLoading === void 0 ? false : _ref$isLoading,
      links = _ref.links,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$y);

  var tabs = reakit.useTabState();
  return /*#__PURE__*/React__default['default'].createElement(Role.Role, _extends__default['default']({}, rest, {
    as: as,
    className: cx$9('Main', rest.className)
  }), header && /*#__PURE__*/React__default['default'].createElement("h2", {
    className: "ui header"
  }, header), links && /*#__PURE__*/React__default['default'].createElement(reakit.TabList, _extends__default['default']({}, tabs, {
    "aria-label": "Section Navigation",
    className: "ui tabular top attached stackable menu"
  }), links.map(function (link) {
    return /*#__PURE__*/React__default['default'].createElement(MainTabs, _extends__default['default']({}, tabs, {
      activeClassName: styles$f.ActiveLink,
      className: styles$f.Link,
      key: link.label
    }, link));
  })), body && /*#__PURE__*/React__default['default'].createElement(reakit.TabPanel, _extends__default['default']({}, rest, {
    ...
    visible: true
  }), body, isLoading && /*#__PURE__*/React__default['default'].createElement(DataUrl.Loader, null)), children, footer && /*#__PURE__*/React__default['default'].createElement("div", {
...
DataUrl.styleInject(css_248z$e);
...
var propTypes$$ = {
  ...
  icon: pt__default$1['default'].object,
  label: pt__default$1['default'].string.isRequired,
  linkComponent: pt__default$1['default'].oneOfType([pt__default$1['default'].shape({
    // Kind of a hack, but making sure that there is a render function
    // on the link component being passed so we know it is supposed to render
    render: pt__default$1['default'].func
  }), // This is for some of the other possible link types on older routers
  pt__default$1['default'].func, // or if someone wants to define a DOM element 'a', 'div', etc
  pt__default$1['default'].string]),
  // eslint-disable-next-line react/forbid-prop-types -- Could be anything
  linkComponentProps: pt__default$1['default'].object,
  post: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node])
};
...
var NavLink = function NavLink(_ref) {
  var icon = _ref.icon,
      ...
      linkComponentProps = _ref.linkComponentProps,
      post = _ref.post,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$x);

  return /*#__PURE__*/React__default['default'].createElement(reakit.Button, _extends__default['default']({}, rest, linkComponentProps, {
    as: linkComponent,
    className: styles$e.NavLink
  }), /*#__PURE__*/React__default['default'].createElement(Flex, {
    space: "start",
    vAlign: "center"
  }, icon && /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(react.Icon, {
    className: "icon",
    icon: icon,
    inline: true,
    width: 18
    ...
    className: "label"
  }, label), post && /*#__PURE__*/React__default['default'].createElement(Flex.Item, {
    push: true
  }, post)));
};
...
var propTypes$_ = {
  links: pt__default$1['default'].arrayOf(pt__default$1['default'].shape(LINK_SHAPE))
};

var NavLinks = function NavLinks(_ref) {
  var links = _ref.links;
  return links ? links.map(function (link, i) {
    return /*#__PURE__*/React__default['default'].createElement(NavLink, _extends__default['default']({}, link, {
      key: link.label || i
    }));
  }) : null;
};
...
var propTypes$Z = {
  label: pt__default$1['default'].string,
  links: pt__default$1['default'].arrayOf(pt__default$1['default'].shape(LINK_SHAPE))
};
...
var NavMenu = function NavMenu(_ref) {
  var _ref$label = _ref.label,
      ...
      links = _ref.links,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$w);

  return /*#__PURE__*/React__default['default'].createElement(reakit.DisclosureContent, _extends__default['default']({}, rest, {
    "aria-label": label,
    className: styles$e.NavMenu
  }), /*#__PURE__*/React__default['default'].createElement(NavLinks, {
    links: links
  }));
};
...
var NavMenuButton = function NavMenuButton(_ref) {
  var _ref$label = _ref.label,
      label = _ref$label === void 0 ? 'Menu' : _ref$label,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$v);

  return /*#__PURE__*/React__default['default'].createElement(reakit.Disclosure, _extends__default['default']({
...
var NavSection = function NavSection(_ref) {
  var label = _ref.label,
      links = _ref.links;
  var disclosure = reakit.useDisclosureState();
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(NavMenuButton, _extends__default['default']({}, disclosure, {
    label: label
  })), /*#__PURE__*/React__default['default'].createElement(NavMenu, _extends__default['default']({}, disclosure, {
    label: label,
    links: links
  })));
};
...
var cx$8 = classNames__default['default'].bind(styles$e);
var sectionShape = {
  label: pt__default$1['default'].string.isRequired,
  links: pt__default$1['default'].arrayOf(pt__default$1['default'].shape(LINK_SHAPE))
};
var propTypes$W = {
  as: pt__default$1['default'].string,
  links: pt__default$1['default'].arrayOf(pt__default$1['default'].oneOfType([pt__default$1['default'].shape(LINK_SHAPE), pt__default$1['default'].shape(sectionShape)]))
};
...
var Nav = function Nav(_ref) {
  var _ref$as = _ref.as,
      as = _ref$as === void 0 ? 'div' : _ref$as,
      links = _ref.links,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$u);

  return /*#__PURE__*/React__default['default'].createElement(Role.Role, _extends__default['default']({}, rest, {
    as: as,
    className: cx$8('Nav', rest.className)
  }), links === null || links === void 0 ? void 0 : links.map(function (link, i) {
    var props = _extends__default['default']({
      key: link.label || i
    }, link);

    return link.links ? /*#__PURE__*/React__default['default'].createElement(NavSection, props) : /*#__PURE__*/React__default['default'].createElement(NavLink, props);
  }));
};
...
DataUrl.styleInject(css_248z$d);

var propTypes$V = {
  detail: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  header: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  list: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  nav: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node])
};
...
var BaristaStructure = function BaristaStructure(_ref) {
  ...
  }, header), /*#__PURE__*/React__default['default'].createElement("nav", {
    className: styles$d._nav
  }, nav), /*#__PURE__*/React__default['default'].createElement("main", {
    className: styles$d._main
  }, /*#__PURE__*/React__default['default'].createElement("section", {
    className: styles$d._list
  }, /*#__PURE__*/React__default['default'].createElement(React.Suspense, {
    fallback: /*#__PURE__*/React__default['default'].createElement(BaristaStructure.List, {
      isLoading: true
    })
  }, list)), /*#__PURE__*/React__default['default'].createElement("section", {
    className: styles$d._detail
  }, /*#__PURE__*/React__default['default'].createElement(React.Suspense, {
    fallback: /*#__PURE__*/React__default['default'].createElement(BaristaStructure.Detail, {
      isLoading: true
    })
  }, detail))));
};
...
var cx$7 = classNames__default['default'].bind(styles$d);
var propTypes$U = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  header: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  isLoading: pt__default$1['default'].bool
...
var BaristaStructureDetail = function BaristaStructureDetail(_ref) {
  var children = _ref.children,
      ...
      _ref$isLoading = _ref.isLoading,
      isLoading = _ref$isLoading === void 0 ? false : _ref$isLoading,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$t);

  var className = rest.className,
      props = _objectWithoutPropertiesLoose__default['default'](rest, _excluded2$5);
  ...
  }, header), children, isLoading && !children && /*#__PURE__*/React__default['default'].createElement(DataUrl.Loader, null));
};
...
var propTypes$T = {
  title: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node])
};
...
var cx$6 = classNames__default['default'].bind(styles$d);
var propTypes$S = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  header: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  isLoading: pt__default$1['default'].bool
...
var BaristaStructureList = function BaristaStructureList(_ref) {
  var children = _ref.children,
      ...
      _ref$isLoading = _ref.isLoading,
      isLoading = _ref$isLoading === void 0 ? false : _ref$isLoading,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$s);

  var className = rest.className,
      props = _objectWithoutPropertiesLoose__default['default'](rest, _excluded2$4);
...
var StructureNavLink = function StructureNavLink(_ref) {
  var children = _ref.children,
      ...
      linkComponent = _ref$linkComponent === void 0 ? 'a' : _ref$linkComponent,
      linkComponentProps = _ref.linkComponentProps,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$r);

  // const LinkComponent = linkComponent;
  return /*#__PURE__*/React__default['default'].createElement(reakit.MenuItem, _extends__default['default']({
    as: linkComponent
  }, rest, linkComponentProps), children ? children : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, icon && /*#__PURE__*/React__default['default'].createElement(react.Icon, {
    className: "icon",
    icon: icon,
    inline: true,
    width: 18
...
var BaristaStructureNav = function BaristaStructureNav(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    return /*#__PURE__*/React__default['default'].createElement(StructureNavLink, _extends__default['default']({
...
DataUrl.styleInject(css_248z$c);

var _excluded$q = ["children", "label", "style", "color"];
var propTypes$P = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].node, pt__default$1['default'].arrayOf(pt__default$1['default'].node)]),

  /** Color of the border */
  color: pt__default$1['default'].string,
  ...
  style: pt__default$1['default'].object
};
var cx$5 = classNames__default['default'].bind(styles$c);
...
var AreaPlaceholder = function AreaPlaceholder(_ref) {
  var children = _ref.children,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$q);
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", _extends__default['default']({}, rest, {
    ...
    style: _extends__default['default']({}, style, {
      borderColor: color
    })
...
DataUrl.styleInject(css_248z$b);

var propTypes$O = {
  isMinimal: pt__default$1['default'].bool
};
...
var TemporaryEmpty = function TemporaryEmpty(_ref) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement("em", null, "No data..."));
};
...
var propTypes$M = {
  ...
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object]),

  /** Display Json details open on mount */
  isInitialOpen: pt__default$1['default'].bool,
...
var JsonPlaceholder = function JsonPlaceholder(_ref) {
  var data = _ref.data,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$p);

  var records = Array.isArray(data) ? data.length : typeof data === 'object' && data !== null ? Object.keys(data).length : null;

  var _getStatusFromDataLen = DataUrl.getStatusFromDataLength(records),
      isEmpty = _getStatusFromDataLen.isEmpty,
      isLoading = _getStatusFromDataLen.isLoading;

  return /*#__PURE__*/React__default['default'].createElement("details", _extends__default['default']({}, rest, {
  ...
  }, title), isLoading ? /*#__PURE__*/React__default['default'].createElement(TemporaryLoading, {
    isMinimal: true
  }) : isEmpty ? /*#__PURE__*/React__default['default'].createElement(TemporaryEmpty, {
    isMinimal: true
  }) : /*#__PURE__*/React__default['default'].createElement("pre", {
    className: styles$b.Pre
  }, /*#__PURE__*/React__default['default'].createElement("code", null, JSON.stringify(data, null, '  '))));
};

JsonPlaceholder.propTypes = propTypes$M;

var DEFAULT_TRIGGER$1 = /*#__PURE__*/React__default['default'].createElement(Button.Button, {
  className: DataUrl.styles._ + " ui basic icon button"
}, /*#__PURE__*/React__default['default'].createElement(react.InlineIcon, {
  icon: icons.verticalmenuIcon
}));
var ACTION_SHAPE = pt__default$1['default'].shape({
  label: pt__default$1['default'].string,
  onClick: pt__default$1['default'].func
});
var ACTION_STACK_PROP_TYPES = {
  actions: pt__default$1['default'].arrayOf(ACTION_SHAPE).isRequired,
  isInitialOpen: pt__default$1['default'].bool,
  placement: pt__default$1['default'].oneOf(['bottom-end', 'bottom-start']),
  title: pt__default$1['default'].string,
  trigger: pt__default$1['default'].node
};

var propTypes$L = {
  actions: pt__default$1['default'].arrayOf(ACTION_SHAPE)
};
...
var ButtonStack = function ButtonStack(_ref) {
  ...
  return actions === null || actions === void 0 ? void 0 : actions.map(function (_ref2, i) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(DataUrl.Button, {
      content: label,
      key: label + i,
...
var propTypes$K = {
  handler: pt__default$1['default'].func,
  hide: pt__default$1['default'].func.isRequired,
...
var DropdownStackItem = function DropdownStackItem(_ref) {
  var hide = _ref.hide,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$o);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Menu.MenuItem, _extends__default['default']({}, rest, {
...
DataUrl.styleInject(css_248z$a);

var MemoizedDropdownItem = /*#__PURE__*/React.memo(DropdownStackItem);
...
var DropdownStack = function DropdownStack(_ref) {
  ...
  var menuState = Menu.useMenuState({
    ...
    unstable_popperModifiers: [DataUrl.popperOverTrigger],
    visible: isInitialOpen
  });
  return actions && actions.length > 0 ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Menu.MenuButton, _extends__default['default']({}, menuState, trigger.props), function (disclosureProps) {
    return /*#__PURE__*/React__default['default'].cloneElement(trigger, disclosureProps);
  }), /*#__PURE__*/React__default['default'].createElement(Menu.Menu, _extends__default['default']({}, menuState, {
    "aria-label": dropdownLabel,
    className: styles$a.Menu
  }), actions === null || actions === void 0 ? void 0 : actions.map(function (action, i) {
    return /*#__PURE__*/React__default['default'].createElement(MemoizedDropdownItem, _extends__default['default']({}, menuState, action, {
...
var propTypes$I = {
  ...
  dropdownIndex: pt__default$1['default'].number
};
...
var ActionStack = function ActionStack(_ref) {
  var _ref$as = _ref.as,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$n);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Role.Role, _extends__default['default']({}, rest, {
    as: as
  }), buttonActions && /*#__PURE__*/React__default['default'].createElement(ButtonStack, {
    actions: buttonActions
  }), dropdownActions && /*#__PURE__*/React__default['default'].createElement(DropdownStack, {
...
var authorDetails = function authorDetails(users, userID) {
  if (users) {
    ...
    return _extends__default['default']({}, user, {
      fullName: fullName,
      userID: userID
    });
  } else {
...
var getMessageAuthorDetails = memoizeOne__default['default'](authorDetails);
...
var propTypes$H = {
  fullName: pt__default$1['default'].string,
  imageUrl: pt__default$1['default'].string,
  square: pt__default$1['default'].bool,
  status: pt__default$1['default'].shape({
    accessibility: pt__default$1['default'].string,
    color: pt__default$1['default'].string,
    icon: pt__default$1['default'].oneOf(['success', 'info', 'warning', 'error', 'unknown']),
    size: pt__default$1['default'].oneOf(['smallest', 'smaller', 'small', 'medium', 'large', 'larger', 'largest']),
    state: pt__default$1['default'].oneOf(['success', 'info', 'warning', 'error', 'unknown'])
  }),
  userID: pt__default$1['default'].number
...
var ChatAvatar = function ChatAvatar(_ref) {
  var fullName = _ref.fullName,
      ...
      status = _ref.status,
      userID = _ref.userID;
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Animation, {
    name: "chatMessage"
  }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Avatar, {
    image: imageUrl,
    name: fullName,
...
var getSharedMessageKeys = function getSharedMessageKeys(_ref) {
  ...
  return {
    ...
    gutter: /*#__PURE__*/React__default['default'].createElement(ChatAvatar, messageAuthor),
    key: message.id
  };
};

var translatedDetails = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "Translated ", /*#__PURE__*/React__default['default'].createElement(reactIconsNorthstar.TranslationIcon, {
  size: "small"
}));
...
var validateMessageObj = function validateMessageObj(propTypes, messageObject, displayName) {
  pt__default$1['default'].checkPropTypes(propTypes, messageObject, 'Chat `message` property', displayName + " [" + messageObject.message.id + "]");
};

var IMAGE_ATTACHMENT_TYPES = ['gif', 'jpeg', 'jpg', 'png', 'svg', 'tiff'];
var propTypes$G = {
  authorName: pt__default$1['default'].string,
  handleDownloadAttachment: pt__default$1['default'].func.isRequired,
  handleScrollToBottom: pt__default$1['default'].func.isRequired,
  isSessionUser: pt__default$1['default'].bool,
  metadata: pt__default$1['default'].shape({
    height: pt__default$1['default'].number,
    size: pt__default$1['default'].oneOfType([pt__default$1['default'].number, pt__default$1['default'].string]),
    type: pt__default$1['default'].string,
    url: pt__default$1['default'].string,
    width: pt__default$1['default'].number
  }).isRequired,
  timestamp: pt__default$1['default'].string.isRequired
};
...
var ChatAttachment = function ChatAttachment(_ref) {
  ...
  React__default['default'].createElement(reactNorthstar.Image, {
    fluid: true,
    height: height,
  ...
  React__default['default'].createElement(reactNorthstar.Attachment, {
    actionable: true,
    ...
    }, type), /*#__PURE__*/React__default['default'].createElement(reactIconsNorthstar.FilesEmptyIcon, {
      outline: true
    })),
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Animation, {
    name: "chatMessage"
  }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Chat.Message, {
    author: authorName,
    content: attachment,
    mine: isSessionUser,
    timestamp: timestamp
...
var objPropTypes$5 = {
  handleScrollToBottom: pt__default$1['default'].func.isRequired,
  isSessionUser: pt__default$1['default'].bool,
  message: pt__default$1['default'].object.isRequired,
  messageAuthor: pt__default$1['default'].object,
  ref: pt__default$1['default'].object.isRequired
...
var getChatAttachmentObj = function getChatAttachmentObj(obj) {
  ...
  return _extends__default['default']({}, getSharedMessageKeys(obj), {
    message: /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Ref, {
      id: message.id,
      innerRef: ref
    }, /*#__PURE__*/React__default['default'].createElement(ChatAttachment, _extends__default['default']({}, message, {
...
var propTypes$F = {
  authorName: pt__default$1['default'].string,
  isSessionUser: pt__default$1['default'].bool,
  isTranslated: pt__default$1['default'].bool,
  text: pt__default$1['default'].oneOfType([pt__default$1['default'].string, pt__default$1['default'].node, pt__default$1['default'].arrayOf(pt__default$1['default'].node)]),
  timestamp: pt__default$1['default'].string.isRequired
};
...
var getChatMessageObj = function getChatMessageObj(obj) {
  ...
  return _extends__default['default']({}, getSharedMessageKeys(obj), {
    message: /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Ref, {
      id: message.id,
      innerRef: ref
    }, /*#__PURE__*/React__default['default'].createElement(ChatMessage, _extends__default['default']({}, message, {
      authorName: messageAuthor === null || messageAuthor === void 0 ? void 0 : messageAuthor.fullName,
      id: message.id,
      isSessionUser: isSessionUser,
...
var propTypes$E = {
  authorName: pt__default$1['default'].string,
  isSessionUser: pt__default$1['default'].bool,
  options: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
    content: pt__default$1['default'].string.isRequired,
    key: pt__default$1['default'].string.isRequired,
    onClick: pt__default$1['default'].func.isRequired
  })).isRequired,
  timestamp: pt__default$1['default'].string.isRequired
};
...
var ChatOptions = function ChatOptions(_ref) {
  var authorName = _ref.authorName,
      ...
      timestamp = _ref.timestamp;
  var itemToString = React.useCallback(function (value) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Animation, {
    ...
    author: authorName,
    content: options.length > 3 ? /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Dropdown, {
      itemToString: itemToString,
      items: options.map(function (option, i) {
        return _extends__default['default']({}, option);
      }),
      noResultsMessage: "We couldn't find any matches.",
      placeholder: "Select an option..."
    }) : /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Flex, {
      column: true,
      gap: "gap.small"
    }, options.map(function (option) {
      return /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Button, _extends__default['default']({}, option, {
        fluid: true,
        key: option.key
      }));
    })),
...
var objPropTypes$3 = {
  isSessionUser: pt__default$1['default'].bool,
  message: pt__default$1['default'].object.isRequired,
  messageAuthor: pt__default$1['default'].object.isRequired,
  ref: pt__default$1['default'].object.isRequired
}; // This returns the object that FUI is expecting, along with the component and props
...
var getChatOptionsObj = function getChatOptionsObj(obj) {
  ...
  getChatMessageObj(obj), _extends__default['default']({}, getSharedMessageKeys(obj), {
    key: message.id + "_buttons",
    message: /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Ref, {
      id: message.id,
      innerRef: ref
    }, /*#__PURE__*/React__default['default'].createElement(ChatOptions, _extends__default['default']({}, message, {
      authorName: messageAuthor === null || messageAuthor === void 0 ? void 0 : messageAuthor.fullName,
      isSessionUser: isSessionUser
    })))
  })];
...
var ChatSystem = function ChatSystem(_ref) {
  var text = _ref.text;
  return /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Animation, {
    name: "chatMessage"
  }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Divider, {
    color: "brand",
    content: text,
    important: true
  }));
...
var getChatSystemObj = function getChatSystemObj(obj) {
  ...
  return {
    ...
    children: /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Ref, {
      id: message.id,
      innerRef: ref
    }, /*#__PURE__*/React__default['default'].createElement(ChatSystem, message))),
    key: message.id
  };
};
...
var ChatTyping = function ChatTyping(_ref2) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Animation, {
    ...
    content: /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Provider, {
      theme: {
        animations: {
          wiggle: wiggle
        }
      }
    }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Animation, {
      name: "wiggle"
    }, /*#__PURE__*/React__default['default'].createElement(reactIconsNorthstar.MoreIcon, {
      size: "larger",
...
var getChatTypingObj = function getChatTypingObj(obj) {
  ...
  return _extends__default['default']({}, getSharedMessageKeys(obj), {
    message: /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Ref, {
      id: message.id,
      innerRef: ref
    }, /*#__PURE__*/React__default['default'].createElement(ChatTyping, _extends__default['default']({}, message, {
      authorName: messageAuthor === null || messageAuthor === void 0 ? void 0 : messageAuthor.fullName,
      isSessionUser: isSessionUser
    })))
  });
...
getChatTypingObj.propTypes = {
  testShit: pt__default$1['default'].bool.isRequired
};

var propTypes$B = {};

var SupportFeedback = function SupportFeedback() {
  return /*#__PURE__*/React__default['default'].createElement("h1", null, "SupportFeedbackWidget");
};
...
var propTypes$A = {
  // eslint-disable-next-line react/forbid-prop-types -- We do not know what the object params might be in this case
  value: pt__default$1['default'].object
};
...
var TicketResolved = function TicketResolved() {
  ...
  return /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Card, {
    "aria-roledescription": "Ticket resolved survey"
  }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Card.Header, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Flex, {
    gap: "gap.small",
    vAlign: "center"
  }, /*#__PURE__*/React__default['default'].createElement(ChatAvatar, {
    imageUrl: "https://www.espressive.com/wp-content/uploads/2018/07/barista-notalk-bubble.png",
    square: true
  }), /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Flex, {
    column: true
  }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Text, {
    content: "Did this resolve your request?",
    weight: "bold"
  })))), /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Card.Body, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Flex, {
    column: true,
    gap: "gap.small"
  }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.RadioGroup, {
...
var propTypes$z = {
  metadata: pt__default$1['default'].shape({
    widget: pt__default$1['default'].shape({
      widget: pt__default$1['default'].string.isRequired
    }).isRequired
  }).isRequired
};
...
var ChatWidget = function ChatWidget(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Widget, props);
};
...
var getChatWidgetObj = function getChatWidgetObj(obj) {
  ...
  return {
    // NOTE: System messages are expected to be returned as children, not as a `message` key
    children: /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Ref, {
      id: message.id,
      innerRef: ref
    }, /*#__PURE__*/React__default['default'].createElement(ChatWidget, _extends__default['default']({
      authorName: messageAuthor === null || messageAuthor === void 0 ? void 0 : messageAuthor.fullName,
      isSessionUser: isSessionUser
    }, message))),
    key: message.id
...
var propTypes$y = {
  ...
  messages: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
    attached: pt__default$1['default'].oneOf(['top', true, 'bottom']),
    id: pt__default$1['default'].string.isRequired,
    sys_date_created: pt__default$1['default'].string.isRequired,

    /** Should match one of the allowed message types */
    type: pt__default$1['default'].oneOf(Object.keys(messageTypes)).isRequired,
    user_id: pt__default$1['default'].number
  })),

  /** The ID of the current logged in user, should match a key in the `users` prop */
  sessionUserID: pt__default$1['default'].number,

  /** Flat map of users to display. Keys should be a user ID. */
  users: pt__default$1['default'].shape({
    firstName: pt__default$1['default'].string,
    imageUrl: pt__default$1['default'].string,
    lastName: pt__default$1['default'].string // status: pt.shape({
    //   color: pt.string,
    //   icon: pt.string,
    // }),
...
var ChatMessages = function ChatMessages(_ref) {
  ...
  var latestMessageRef = React.useRef(null); // We scroll to the latest message, not to the bottom of the chat
  ...
  var animations = {
    chatMessage: messages ? _extends__default['default']({}, reactNorthstar.teamsTheme.animations.scaleEnterNormal) : _extends__default['default']({}, reactNorthstar.teamsTheme.animations.fadeEnterUltraSlow, {
      direction: 'alternate-reverse',
      iterationCount: 'infinite'
    })
  };
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Provider, {
    theme: messages ? {
      animations: animations
    } : _extends__default['default']({
      animations: animations
    }, loadingTheme)
  }, /*#__PURE__*/React__default['default'].createElement(reactNorthstar.Chat, {
    items: items
  })));
};

ChatMessages.propTypes = propTypes$y;
ChatMessages.Provider = DataUrl.ChatProvider;
...
DataUrl.styleInject(css_248z$9);

var _excluded$m = ["as", "count", "children", "className", "style"];
var cx$4 = classNames__default['default'].bind(styles$9);
var propTypes$x = {
  ...
  className: pt__default$1['default'].string,

  /** The number of columns to allocate */
  count: pt__default$1['default'].oneOfType([pt__default$1['default'].number, pt__default$1['default'].oneOf(['auto'])]),

  /** Columns can have inline styles */
  style: pt__default$1['default'].shape(pt__default$1['default'].object)
};
...
var Columns = function Columns(_ref) {
  _ref.as;
      ...
      className = _ref.className,
      style = _ref.style,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$m);
  ...
  if (typeof count === 'number' && style) {
    mergedStyle = _extends__default['default']({}, style, mergedStyle);
  }

  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reakit.Role, _extends__default['default']({
...
DataUrl.styleInject(css_248z$8);
...
DataUrl.styleInject(css_248z$7);

var propTypes$w = {
  message: pt__default$1['default'].string,
  // eslint-disable-next-line react/forbid-prop-types -- We do not know what the object params might be in this case
  style: pt__default$1['default'].object
};
...
var InfoPopover = function InfoPopover(_ref) {
  var message = _ref.message,
      style = _ref.style;
  var popover = Popover.usePopoverState({
    animated: 150,
    gutter: 8,
    placement: 'bottom-end'
  });
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Popover.PopoverDisclosure, _extends__default['default']({}, popover, {
    className: styles$7.Disclosure + " ui small basic circular icon button",
    style: style
  }), /*#__PURE__*/React__default['default'].createElement("i", {
    "aria-hidden": "true",
    className: "info icon"
  })), /*#__PURE__*/React__default['default'].createElement(Popover.Popover, _extends__default['default']({}, popover, {
    "aria-label": "Info",
...
var cx$3 = classNames__default['default'].bind(styles$8);
var propTypes$v = {
  /** A widget can display action buttons */
  actions: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
    content: pt__default$1['default'].string
  })),
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].node, pt__default$1['default'].arrayOf(pt__default$1['default'].node)]),
  ...
  description: pt__default$1['default'].string,

  /** The height of a widget */
  height: pt__default$1['default'].oneOfType([pt__default$1['default'].number, pt__default$1['default'].oneOf(['auto'])]),
  // A widget can be in an empty state
  isEmpty: pt__default$1['default'].bool,
  // A widget can be in a loading state
  isLoading: pt__default$1['default'].bool,

  /** A widget can contain scrolling content */
  isScrolling: pt__default$1['default'].bool,
...
var Widget = function Widget(_ref) {
  var actions = _ref.actions,
      ...
      title = _ref.title,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$l);
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    return /*#__PURE__*/React__default['default'].createElement(reakit.Button, _extends__default['default']({
      key: i
    }, action, {
      className: "ui small basic right floated button"
    }), action === null || action === void 0 ? void 0 : action.content);
  }), description && /*#__PURE__*/React__default['default'].createElement(InfoPopover, {
    message: description,
    style: {
      "float": 'right'
    }
  ...
  }, title), /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement("div", {
    className: cx$3(className, {
      Data: true,
  ...
  }) : isEmpty ? /*#__PURE__*/React__default['default'].createElement("em", null, "No data.") : React.Children.map(children, function (child) {
    return /*#__PURE__*/React.cloneElement(child, _extends__default['default']({}, rest));
  }))));
};
...
var propTypes$u = _extends__default['default']({}, propTypes$v, {
  /** Can have a bottom axis label */
  axisBottomLabel: pt__default$1['default'].string,

  /** Can have a left axis label */
  axisLeftLabel: pt__default$1['default'].string,

  /** Data to display in a widget */
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object]),

  /** The unique value to index by on `data` */
  indexBy: pt__default$1['default'].string,

  /** Values to show from `data` */
  keys: pt__default$1['default'].arrayOf(pt__default$1['default'].string),

  /** The value to use for displaying bar labels */
  label: pt__default$1['default'].string,

  /** Direction to orient the bar */
  layout: pt__default$1['default'].oneOf(['horizontal', 'vertical'])
});
/**
 * Widget for @nivo/bar.
 */
...
var WidgetBar = function WidgetBar(_ref) {
  var axisBottomLabel = _ref.axisBottomLabel,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$k);

  // TODO: Throw an error if no indexBy prop is set and there is no matching attribute in a data object
  var CHART_CONFIG = _extends__default['default']({}, CHART_DEFAULTS, {
    axisBottom: _extends__default['default']({}, AXIS_CONFIG, {
      legend: axisBottomLabel,
      legendOffset: axisBottomLabel ? 32 : 0 // These and the margin calcs are still a little too "magic"

    }),
    axisLeft: _extends__default['default']({}, AXIS_CONFIG, {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState), /*#__PURE__*/React__default['default'].createElement(bar.ResponsiveBar, _extends__default['default']({}, CHART_CONFIG, {
    axisLeft: axisLeft,
    data: data,
    indexBy: indexBy,
    keys: keys,
...
var propTypes$t = _extends__default['default']({}, propTypes$v, {
  /** Data to display in a widget */
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object]),
...
var WidgetBubble = function WidgetBubble(_ref) {
  var data = _ref.data,
      ...
      _ref$label = _ref.label,
      label = _ref$label === void 0 ? 'value' : _ref$label,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$j);
  ...
  var dataState = getDataState(data);
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState), /*#__PURE__*/React__default['default'].createElement(circlePacking.ResponsiveBubble, _extends__default['default']({}, CHART_CONFIG, {
    identity: indexBy,
    root: {
      children: data,
      id: ''
...
var propTypes$s = _extends__default['default']({}, propTypes$v, {
  /** Data to display in a widget */
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object])
});
/**
...
var WidgetGeoMap = function WidgetGeoMap(_ref) {
  var data = _ref.data,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$i);
  ...
  var dataState = getDataState(data);
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState, {
    height: 320
  }), /*#__PURE__*/React__default['default'].createElement(geo.ResponsiveChoroplethCanvas, _extends__default['default']({}, CHART_CONFIG, {
    data: data,
...
var propTypes$r = _extends__default['default']({}, propTypes$v, {
  /** Data to display in a widget */
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object]),
...
var WidgetHeatMap = function WidgetHeatMap(_ref) {
  var data = _ref.data,
      _ref$indexBy = _ref.indexBy,
      indexBy = _ref$indexBy === void 0 ? 'id' : _ref$indexBy,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$h);

  var dataState = getDataState(data);
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState), /*#__PURE__*/React__default['default'].createElement(heatmap.ResponsiveHeatMapCanvas, {
    data: data,
    indexBy: indexBy,
...
var propTypes$q = _extends__default['default']({}, propTypes$v, {
  /** Can have a bottom axis label */
  axisBottomLabel: pt__default$1['default'].string,
...
var WidgetLine = function WidgetLine(_ref) {
  var axisBottomLabel = _ref.axisBottomLabel,
      axisLeftLabel = _ref.axisLeftLabel,
      data = _ref.data,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$g);
  ...
  var dataState = getDataState(data);
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState), /*#__PURE__*/React__default['default'].createElement(line.ResponsiveLine, _extends__default['default']({}, CHART_CONFIG, {
    data: data
  })));
};
...
var propTypes$p = {
  ...
  item: pt__default$1['default'].object.isRequired,
  onClick: pt__default$1['default'].func.isRequired
};
...
var WidgetListAction = function WidgetListAction(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(reakit.Button, {
...
var propTypes$o = _extends__default['default']({}, propTypes$v, {
  /** Data to display in a widget */
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object]),
  ...
  rowAction: pt__default$1['default'].func
});
...
var WidgetList = function WidgetList(_ref2) {
  var data = _ref2.data,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref2, _excluded$f);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState, {
    isScrolling: true
  }), !isLoading && !isEmpty && /*#__PURE__*/React__default['default'].createElement("table", null, /*#__PURE__*/React__default['default'].createElement("thead", null, /*#__PURE__*/React__default['default'].createElement("tr", null, Object.keys(preparedData[0]).map(function (headCol, i) {
    return /*#__PURE__*/React__default['default'].createElement("th", {
      key: i
    }, headCol);
  }), rowAction && /*#__PURE__*/React__default['default'].createElement("th", null))), /*#__PURE__*/React__default['default'].createElement("tbody", null, preparedData === null || preparedData === void 0 ? void 0 : preparedData.map(function (item, i) {
    ...
    }), rowAction && /*#__PURE__*/React__default['default'].createElement("td", {
      style: {
        textAlign: 'right',
        width: '1px'
      }
    }, /*#__PURE__*/React__default['default'].createElement(WidgetListAction, {
      item: data[i],
      onClick: rowAction
    })));
  }))));
...
var propTypes$n = _extends__default['default']({}, propTypes$v, {
  /** Data to display in a widget */
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object])
});
...
var WidgetPie = function WidgetPie(_ref) {
  var data = _ref.data,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$e);

  var dataState = getDataState(data);
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState), /*#__PURE__*/React__default['default'].createElement(pie.ResponsivePie, _extends__default['default']({}, CHART_CONFIG, {
    data: data
  })));
};
...
var propTypes$m = {
  label: pt__default$1['default'].string,
  onClick: pt__default$1['default'].func,
  sub: pt__default$1['default'].oneOfType([pt__default$1['default'].number, pt__default$1['default'].string]),
  value: pt__default$1['default'].oneOfType([pt__default$1['default'].number, pt__default$1['default'].string])
};
...
var WidgetStatsStat = function WidgetStatsStat(_ref) {
  ...
  var handleFocus = React.useCallback(function (_ref2) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(reakit.Clickable, {
    as: "div",
  ...
  }, value), /*#__PURE__*/React__default['default'].createElement("h4", {
    className: styles$8.Label
  }, label), sub && /*#__PURE__*/React__default['default'].createElement("span", {
...
var propTypes$l = _extends__default['default']({}, propTypes$v, {
  /** Data to display in a widget */
  data: pt__default$1['default'].oneOfType([pt__default$1['default'].array, pt__default$1['default'].object])
});
/**
...
var WidgetStats = function WidgetStats(_ref) {
  var data = _ref.data,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$d);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Widget, _extends__default['default']({}, rest, dataState, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(WidgetStatsStat, _extends__default['default']({}, stat, {
      key: stat.label
    }));
  }));
};
...
var WidgetError = function WidgetError(_ref) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement("h4", null, "Error"), message);
};
...
var propTypes$j = {
  ...
  config: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
    widget: pt__default$1['default'].oneOf(widgetKeys).isRequired
  })).isRequired
};
var cx$2 = classNames__default['default'].bind(styles$8);

var Dashboard = function Dashboard(_ref) {
  var _ref$as = _ref.as,
      as = _ref$as === void 0 ? 'div' : _ref$as,
      config = _ref.config,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$c);

  var renderWidget = function renderWidget(_ref2, index) {
    var widget = _ref2.widget,
        rest = _objectWithoutPropertiesLoose__default['default'](_ref2, _excluded2$3);

    var key = (rest === null || rest === void 0 ? void 0 : rest.title) + widget || index;
    var Component = WIDGETS[widget];
    return Component ? /*#__PURE__*/React__default['default'].createElement(Component, _extends__default['default']({}, rest, {
      key: key
    })) :
    /*#__PURE__*/
    // TODO: This should eventually become a message component for displaying helpful developer messages
    React__default['default'].createElement(WidgetError, {
      key: key,
      message: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("p", null, /*#__PURE__*/React__default['default'].createElement("code", null, widget), ' is not a valid value for ', /*#__PURE__*/React__default['default'].createElement("code", null, "widget"), "."), /*#__PURE__*/React__default['default'].createElement("p", null, "Try:", ' ', widgetKeys.map(function (key, i) {
        return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("code", {
          key: key
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(Role.Role, _extends__default['default']({}, rest, {
    as: as,
    className: cx$2('Dashboard', rest.className)
  }), config ? config.map(function (widget) {
    return renderWidget(widget);
  }) : /*#__PURE__*/React__default['default'].createElement("em", null, "No config defined.")));
};
...
DataUrl.styleInject(css_248z$6);
...
var FormProvider = function FormProvider(_ref) {
  var children = _ref.children,
      value = _ref.value,
      props = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$b);
  ...
  var mergedValues = _extends__default['default']({}, DataUrl.ModuleContext.defaultValue, value, {
    formMethods: formMethods
  });

  return /*#__PURE__*/React__default['default'].createElement(DataUrl.ModuleProvider, _extends__default['default']({
    value: mergedValues
  }, props), /*#__PURE__*/React__default['default'].createElement("form", {
...
// Action Modules
var actionModules = {
  button: DataUrl.ActionButton,
  edit: DataUrl.ActionEdit
};
var dataModules = {
  checkbox: DataUrl.DataCheckbox,
  // switch: DataCheckbox,
  color: DataUrl.DataColor,
  date: DataUrl.DataDate,
  datetime: DataUrl.DataDateTime,
  email: DataUrl.DataEmail,
  file: DataUrl.DataFile,
  image: DataUrl.DataImage,
  json: DataUrl.DataJson,
  month: DataUrl.DataMonth,
  number: DataUrl.DataNumber,
  password: DataUrl.DataPassword,
  radio: DataUrl.DataRadio,
  range: DataUrl.DataRange,
  select: DataUrl.DataSelect,
  tel: DataUrl.DataTel,
  text: DataUrl.DataText,
  textarea: DataUrl.DataTextArea,
  time: DataUrl.DataTime,
  url: DataUrl.DataUrl,
  week: DataUrl.DataWeek
};

var propTypes$h = {
  cancelLabel: pt__default$1['default'].string,
  editLabel: pt__default$1['default'].string,
  saveLabel: pt__default$1['default'].string
};
...
var ActionEdit = function ActionEdit(_ref) {
  ...
  var _useContext = React.useContext(DataUrl.ModuleContext),
  ...
  var handleReset = React.useCallback(function () {
    ...
    {
      name: 'edit.cancel'
    }, _extends__default['default']({}, data));
    exitEditMode();
  ...
  var handleEdit = React.useCallback(function () {
    ...
    reset(_extends__default['default']({}, data));
    onAction && onAction( // fake target
    {
      name: 'edit.start'
    }, _extends__default['default']({}, data));
  ...
  var onSubmit = React.useCallback(function (incomingData) {
    onAction && onAction( // fake target
    {
      name: 'edit.save'
    }, _extends__default['default']({}, data, incomingData));
    exitEditMode();
  }, [onAction, exitEditMode, data]);
  return isEditing ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(reakit.Button, {
    ...
    name: "delete"
  })), /*#__PURE__*/React__default['default'].createElement(reakit.Button, {
...
var propTypes$g = {
  children: pt__default$1['default'].oneOf([pt__default$1['default'].node, pt__default$1['default'].arrayOf(pt__default$1['default'].node)]),
  ratio: pt__default$1['default'].arrayOf(pt__default$1['default'].oneOfType([pt__default$1['default'].number, pt__default$1['default'].string]))
};
...
var FormRow = function FormRow(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement("div", {
...
var propTypes$f = {
  actions: pt__default$1['default'].arrayOf(pt__default$1['default'].oneOfType([pt__default$1['default'].shape(DataUrl.propTypes), pt__default$1['default'].shape(propTypes$h)]))
};
...
var availableActionModules = _extends__default['default']({}, actionModules, formActionModules);

var formDataModules = _extends__default['default']({}, formModules, dataModules);
...
var propTypes$e = {
  ...
  actions: pt__default$1['default'].shape({
    /** An array of action objects */
    modules: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
      /** A string that specifies the type of module to use */
      module: pt__default$1['default'].oneOf(actionModuleOptions$2).isRequired
    }))
  }),
   ...
   */
  data: pt__default$1['default'].shape({}),

  /** Here you can describe each of the visible columns in your table. */
  dataDisplay: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
    module: pt__default$1['default'].oneOf(dataModuleOptions$2).isRequired
  })),

  /** a form can be editable */
  isEditable: pt__default$1['default'].bool,

  /** A form can start in an editing state */
  isInitialEditing: pt__default$1['default'].bool,

  /** Specifies if a loading state is show */
  isLoading: pt__default$1['default'].bool,

  /** A form can emit events on every action*/
  onAction: pt__default$1['default'].func
...
var formFields = function formFields(display, data) {
  var renderField = function renderField(field) {
    var module = field.module,
        label = field.label,
        rest = _objectWithoutPropertiesLoose__default['default'](field, _excluded$a);
    ...
    return Module ? /*#__PURE__*/React__default['default'].createElement(Module, _extends__default['default']({}, moduleProps, {
      key: key,
      label: label,
      value: moduleValue
    })) : /*#__PURE__*/React__default['default'].createElement(DataUrl.ModuleError, {
      moduleName: module,
  ...
  return display === null || display === void 0 ? void 0 : display.map(function (field, i) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, {
      key: key
    }, FormModule ? /*#__PURE__*/React__default['default'].createElement(FormModule, field, renderFields(fields)) : renderField(field));
  });
};
...
var renderActions = function renderActions(actions) {
  ...
  return actions === null || actions === void 0 ? void 0 : (_actions$modules = actions.modules) === null || _actions$modules === void 0 ? void 0 : _actions$modules.map(function (action, idx) {
    var module = action.module,
        rest = _objectWithoutPropertiesLoose__default['default'](action, _excluded2$2);
    ...
    return Action ? /*#__PURE__*/React__default['default'].createElement(Action, _extends__default['default']({
      key: key
    }, myProps)) : /*#__PURE__*/React__default['default'].createElement(DataUrl.ModuleError, {
      key: key,
      moduleName: module,
...
var FormOld = function FormOld(_ref3) {
  ...
  var actions = _ref3.actions,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref3, _excluded3);
  ...
  DataUrl.useDeveloperMessage(isEditingWithoutDataDisplay, WARNING_STRINGS$1.INVALID_EDITING_AND_DISPLAY);

  var _getStatusFromDataLen = DataUrl.getStatusFromDataLength( // We convert data to an array to check its length
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, !isEmpty ? /*#__PURE__*/React__default['default'].createElement(FormProvider, _extends__default['default']({
    value: {
      data: data,
  ...
  }, rest), isLoading ? /*#__PURE__*/React__default['default'].createElement(TemporaryLoading, null) : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, fields, /*#__PURE__*/React__default['default'].createElement(ActionBar, {
    actions: renderedActions
  }))) : /*#__PURE__*/React__default['default'].createElement(TemporaryEmpty, null));
};
...
DataUrl.styleInject(css_248z$5);

var propTypes$d = {
  // eslint-disable-next-line react/forbid-prop-types -- Could be anything
  compositeState: pt__default$1['default'].object,
  description: pt__default$1['default'].string,
  label: pt__default$1['default'].string,
  linkComponent: pt__default$1['default'].oneOfType([pt__default$1['default'].string, pt__default$1['default'].shape({
    // Kind of a hack, but making sure that there is a render function
    // on the link component being passed so we know it is supposed to render
    render: pt__default$1['default'].func
  })]),
  ...
  linkComponentProps: pt__default$1['default'].object,
  post: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  pre: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node])
};
...
var ListItem = function ListItem(_ref) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(Composite.CompositeItem, _extends__default['default']({}, linkComponentProps, compositeState, {
    as: linkComponent,
    className: styles$5.Link
  }), /*#__PURE__*/React__default['default'].createElement(Flex, {
    space: "start",
    vAlign: "center"
  }, pre, /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$5.Content
  }, label && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$5.Label
  }, label), description && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$5.Descripton
  }, description)), post && /*#__PURE__*/React__default['default'].createElement(Flex.Item, {
    push: true
  }, post))));
};
...
var propTypes$c = {
  ...
  data: pt__default$1['default'].arrayOf(pt__default$1['default'].shape(propTypes$d))
};

var List = function List(_ref) {
  var data = _ref.data,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$9);

  var compositeState = Composite.useCompositeState();
  return /*#__PURE__*/React__default['default'].createElement(Composite.Composite, _extends__default['default']({}, rest, {
    ...
    className: "ui loader"
  }))) : (data === null || data === void 0 ? void 0 : data.length) < 1 ? /*#__PURE__*/React__default['default'].createElement("div", {
    className: "ui basic center aligned segment",
    style: {
      minHeight: '10rem'
    }
  }, /*#__PURE__*/React__default['default'].createElement("em", null, "No data.")) : data === null || data === void 0 ? void 0 : data.map(function (item, i) {
...
var usePaginationState = function usePaginationState(initialState) {
  var safeInitialState = initialState ? _extends__default['default']({}, INITIAL_STATE$1, initialState) : INITIAL_STATE$1;

  var _useReducer = React.useReducer(paginationReducer, safeInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];

  var setCurrentPage = React.useCallback(function (currentPage) {
    return dispatch({
      payload: currentPage,
      type: REDUCER_ACTIONS.SET_CURRENT_PAGE
    });
  }, []);
  var setPerPage = React.useCallback(function (perPage) {
    return dispatch({
      payload: perPage,
...
DataUrl.styleInject(css_248z$4);
...
var propTypes$b = {
  ...
  state: pt__default$1['default'].exact({
    currentPage: pt__default$1['default'].number,
    perPage: pt__default$1['default'].number,
    setCurrentPage: pt__default$1['default'].func,
    setPerPage: pt__default$1['default'].func
  }),

  /** The total number of records. undefined (default) sets the component to loading state. 0 sets the component to an empty state. */
  totalRecordCount: pt__default$1['default'].number
};
var cx$1 = classNames__default['default'].bind(styles$4);
...
var Pagination = function Pagination(_ref) {
  var _ref$as = _ref.as,
      ...
      state = _ref.state,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$8);
  ...
  var _getStatusFromDataLen = DataUrl.getStatusFromDataLength(totalRecordCount),
      isLoading = _getStatusFromDataLen.isLoading,
  ...
  DataUrl.useDeveloperMessage(isMissingStateHooks, WARNING_STRINGS.MISSING_STATE_HOOK); // So the rest of pagination display does not blow up, we set the page length
  ...
  var handlePaginationChange = React.useCallback(function (e) {
  ...
  var handlePageChange = React.useCallback(function (e) {
    return setCurrentPage(Number(e.target.value));
  }, [setCurrentPage]);
  var handlePageNext = React.useCallback(function () {
    return setCurrentPage(currentPage + 1);
  }, [currentPage, setCurrentPage]);
  var handlePagePrev = React.useCallback(function () {
    return setCurrentPage(currentPage - 1);
  }, [currentPage, setCurrentPage]);
  ...
  }, totalRecordCount + " record" + (totalRecordCount === 1 ? '' : 's'))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "field"
  ...
  }, "per page"), !isLoading && !isEmpty && /*#__PURE__*/React__default['default'].createElement("p", {
    "aria-label": LABELS.CURRENT_RECORDS,
    className: styles$4.count
  }, "(" + ((currentPage - 1) * recordsPerPage + 1) + "-" + currentPage * recordsPerPage + ")")))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "ui form"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: "inline fields"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, "Page"), /*#__PURE__*/React__default['default'].createElement("select", {
    className: "ui dropdown",
    disabled: isLoading || isEmpty || isMissingStateHooks,
    id: "current-page",
    name: "current-page",
  ...
  })), !isLoading && /*#__PURE__*/React__default['default'].createElement("p", {
    className: styles$4.count
  }, "of " + totalPages)), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "field"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
...
var PROP_TYPES = {
  ...
  title: pt__default$1['default'].string,
  // as to allow polim
  titleAs: pt__default$1['default'].string,
  // Content can show before the title
  titlePost: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  // Content can show after the title
  titlePre: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  // A title can have sub content
  titleSub: pt__default$1['default'].string
};
...
DataUrl.styleInject(css_248z$3);
...
var Title = function Title(_ref) {
  var title = _ref.title,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$7);

  var titleTag = title && /*#__PURE__*/React__default['default'].createElement(reakit.Role, _extends__default['default']({
    as: titleAs,
    className: styles$3.Title
  }, rest), title, " ", titleSub && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$3.Sub
  }, titleSub));
  var isOnlyTitle = (titlePre || titlePost) === undefined;
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, isOnlyTitle ? // Do not render any extra markup if we do not need to.
  titleTag : /*#__PURE__*/React__default['default'].createElement(Flex, {
    className: styles$3._,
    space: "start"
  }, titlePre, titleTag, titlePost && /*#__PURE__*/React__default['default'].createElement(Flex.Item, {
    push: true
  }, /*#__PURE__*/React__default['default'].createElement("div", null, titlePost))));
};
...
_extends__default['default']({
  ...
  isBasic: pt__default$1['default'].bool
}, PROP_TYPES);
...
DataUrl.styleInject(css_248z$2);

var _excluded$6 = ["as", "isBasic", "children", "title", "titleAs", "titlePost", "titlePre", "titleSub"];
var cx = classNames__default['default'].bind(styles$2); // NOTE: propTypes are defined here instead of in ./__globals.js
//       this is because otherwise the props table in Cascara Docs won't show up

var propTypes$a = _extends__default['default']({
  /** HTML tag to allow polymorphism */
  as: pt__default$1['default'].string,
...
var Section = function Section(_ref) {
  var _ref$as = _ref.as,
      ...
      titlePre = _ref.titlePre,
      titleSub = _ref.titleSub,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, _excluded$6);

  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(reakit.Role, _extends__default['default']({}, rest, {
    as: as,
...
var TABLE_SHAPE = {
  /** Actions will be appended to each row, they'll appear as buttons. */
  actions: pt__default$1['default'].shape({
    actionButtonMenuIndex: pt__default$1['default'].number,
    modules: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
      module: pt__default$1['default'].oneOf(actionModuleOptions$1).isRequired
    })),
    // Resolve record actions.
    // A function that returns the actions available to the current row
    resolveRecordActions: pt__default$1['default'].func
  }),
  // An array of objects.
  //
  // Every object in this array will potencially be rendered as a table row.
  data: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({})),
  ...
  dataConfig: pt__default$1['default'].shape({
    ...
    display: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
      module: pt__default$1['default'].oneOf(dataModuleOptions$1).isRequired
    }))
  }),
  ...
  resolveRecordActions: pt__default$1['default'].func,
  // Selection
  selections: pt__default$1['default'].oneOfType([pt__default$1['default'].bool, pt__default$1['default'].exact({
    max: pt__default$1['default'].number
  })]),
  // Unique ID Attribute.
  //
  // specifies the attribute that uniquely identifies every object in the 'data' array.
  uniqueIdAttribute: pt__default$1['default'].string
};
...
DataUrl.styleInject(css_248z$1);

var _excluded$5 = ["children", "value"];
var propTypes$9 = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].node, pt__default$1['default'].arrayOf(pt__default$1['default'].node)]),
  value: pt__default$1['default'].shape({})
};
...
var TableProvider = function TableProvider(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.ModuleProvider, _extends__default['default']({
    value: mergedValues
  }, props), /*#__PURE__*/React__default['default'].createElement("form", null, children));
};
  ...
  switch (type) {
    case 'SELECT':
      if (Array.isArray(payload)) {
        ...
        return ramda.append(payload, state);
      }

    case 'UNSELECT':
      return ramda.without(payload, state);
...
var TableHeader = function TableHeader() {
  ...
  var headerCells = React.useMemo(function () {
  ...
  var actionBarSpacer = modules ? [/*#__PURE__*/React__default['default'].createElement("th", {
    className: styles$1.HeadCell,
    key: 'action-bar-slot'
  })] : [];
  ...
  if (isRowSelectable) {
    newHeaderCells.unshift( /*#__PURE__*/React__default['default'].createElement("th", {
      className: styles$1.HeadCell,
      key: 'selection-toggle-slot'
    }));
  }

  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement("thead", {
...
var propTypes$8 = {
  children: pt__default$1['default'].oneOfType([pt__default$1['default'].node, pt__default$1['default'].arrayOf(pt__default$1['default'].node)]),
  value: pt__default$1['default'].shape({
    record: pt__default$1['default'].shape({})
  })
};
...
var RowProvider = function RowProvider(_ref) {
  ...
  var grandparentValues = React.useContext(DataUrl.ModuleContext);

  var idOfRecordInEditMode = grandparentValues.idOfRecordInEditMode,
      uniqueIdAttribute = grandparentValues.uniqueIdAttribute,
      rest = _objectWithoutPropertiesLoose__default['default'](grandparentValues, _excluded2$1);
  ...
  var mergedValues = _extends__default['default']({}, DataUrl.ModuleContext.defaultValue, rest, value, {
    idOfRecordInEditMode: idOfRecordInEditMode,
    isEditing: isEditing,
...
DataUrl.styleInject(css_248z);

var _excluded$3 = ["actionIndex", "actionName", "content", "isLabeled", "menu"];
var propTypes$7 = {
  actionIndex: pt__default$1['default'].number,
  actionName: pt__default$1['default'].string,
  content: pt__default$1['default'].string,
  isLabeled: pt__default$1['default'].bool,
  menu: pt__default$1['default'].shape({
    hide: pt__default$1['default'].func,
    modal: pt__default$1['default'].bool,
    placement: pt__default$1['default'].string,
    preventBodyScroll: pt__default$1['default']["boolean"],
    unstable_popperModifiers: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
      name: pt__default$1['default'].string,
      options: pt__default$1['default'].shape({
        offset: pt__default$1['default'].func
      })
    }))
  })
};
...
var ActionsMenuItem = function ActionsMenuItem(_ref) {
  ...
  var handleMenuItemClick = React.useCallback(function () {
    menu.hide();

    if (onAction) {
      onAction(_extends__default['default']({
  ...
  return /*#__PURE__*/React__default['default'].createElement(Menu.MenuItem, _extends__default['default']({}, menu, rest, {
    as: "div",
...
var MemoActionsMenuItem = /*#__PURE__*/React__default['default'].memo(ActionsMenuItem);
var DEFAULT_TRIGGER = /*#__PURE__*/React__default['default'].createElement(Button.Button, {
  className: "ui basic icon button"
}, /*#__PURE__*/React__default['default'].createElement(react.InlineIcon, {
  icon: icons.verticalmenuIcon
}));
var propTypes$6 = {
  actions: pt__default$1['default'].arrayOf(pt__default$1['default'].object).isRequired,
  trigger: pt__default$1['default'].node
};
...
var ActionsMenu = function ActionsMenu(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Menu.MenuButton, _extends__default['default']({}, menu, trigger.props, {
    ref: triggerRef
  }), function (disclosureProps) {
    return /*#__PURE__*/React__default['default'].cloneElement(trigger, disclosureProps);
  }), /*#__PURE__*/React__default['default'].createElement(Menu.Menu, _extends__default['default']({}, menu, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(MemoActionsMenuItem, _extends__default['default']({
      key: action.name
    }, action, {
...
var propTypes$5 = {
  checked: pt__default$1['default'].bool,
  indeterminate: pt__default$1['default'].bool,
  name: pt__default$1['default'].string,
  onChange: pt__default$1['default'].func
};
...
var propTypes$4 = {
  id: pt__default$1['default'].string
};
...
var SelectionToggle = function SelectionToggle(_ref) {
  ...
  var handleSelectionToggle = React.useCallback(function (_ref2) {
    var name = _ref2.name;
...
var propTypes$3 = {
  config: pt__default$1['default'].shape({
    columns: pt__default$1['default'].arrayOf(pt__default$1['default'].oneOfType([pt__default$1['default'].shape({
      module: pt__default$1['default'].oneOf(dataModuleOptions).isRequired
    }).isRequired])),
    id: pt__default$1['default'].oneOfType([pt__default$1['default'].string, pt__default$1['default'].number])
  }),
  record: pt__default$1['default'].shape({})
};
...
var TableRow = function TableRow(_ref) {
  ...
  var renderActionModule = function renderActionModule(action, index) {
    var module = action.module,
        rest = _objectWithoutPropertiesLoose__default['default'](action, _excluded$2);

    var key = id + "." + module + "." + (rest.content || module) + "." + index;
    var Action = actionModules[module];
    return Action ? /*#__PURE__*/React__default['default'].createElement(Action, _extends__default['default']({
      key: key
    }, rest)) : /*#__PURE__*/React__default['default'].createElement(DataUrl.ModuleError, {
      key: key,
      moduleName: module,
  ...
  var rowActions = /*#__PURE__*/React__default['default'].createElement("td", {
    className: styles$1.CellActions,
    key: id + "-actionbar"
  }, outsideActions.map(renderActionModule), insideButtonActions.length ? /*#__PURE__*/React__default['default'].createElement(ActionsMenu, {
    actions: insideButtonActions
  }) : null);
  var rowCells = columns.map(function (column) {
    var module = column.module;
        column.isLabeled;
        var rest = _objectWithoutPropertiesLoose__default['default'](column, _excluded2);
    ...
    return /*#__PURE__*/React__default['default'].createElement("td", {
      ...
      key: column.attribute
    }, Module ? /*#__PURE__*/React__default['default'].createElement(Module, _extends__default['default']({}, rest, {
      isLabeled: false,
      value: moduleValue
    })) : /*#__PURE__*/React__default['default'].createElement(DataUrl.ModuleError, {
      moduleName: module,
  ...
  if (isRowSelectable) {
    rowCells.unshift( /*#__PURE__*/React__default['default'].createElement("td", {
      className: styles$1.HeadCell,
      key: "selection-toggle-" + id
    }, /*#__PURE__*/React__default['default'].createElement(SelectionToggle, {
      id: id
    })));
  }

  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement(RowProvider, {
    value: {
      record: record
    }
  }, /*#__PURE__*/React__default['default'].createElement("tr", {
...
var TableBody = function TableBody() {
    ...
    return data === null || data === void 0 ? void 0 : data.map(function (data) {
      return {
        columns: dataDisplay === null || dataDisplay === void 0 ? void 0 : dataDisplay.map(function (itemConfig) {
          return _extends__default['default']({}, itemConfig);
        }),
        data: data,
  ...
  return /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, /*#__PURE__*/React__default['default'].createElement("tbody", {
    className: styles$1.BodyContainer
  }, rows === null || rows === void 0 ? void 0 : rows.map(function (record) {
    var data = record.data,
        rest = _objectWithoutPropertiesLoose__default['default'](record, _excluded$1);
...
var TableBaseOld = function TableBaseOld(_ref2) {
  ...
  var actions = _ref2.actions,
      ...
      rest = _objectWithoutPropertiesLoose__default['default'](_ref2, _excluded);
  ...
  var _useReducer = React.useReducer(listReducer, []),
      selection = _useReducer[0],
      updateSelection = _useReducer[1]; // get a list of record IDs


  var recordIDs = React.useMemo(function () {
  ...
  var rowSelect = React.useCallback(function (rowID) {
  ...
  var rowUnselect = React.useCallback(function (rowID) {
    updateSelection({
      payload: rowID,
      type: UNSELECT
    });
  ...
  return /*#__PURE__*/React__default['default'].createElement(TableProvider, _extends__default['default']({
    value: {
  ...
  }, rest), /*#__PURE__*/React__default['default'].createElement("table", {
    className: styles$1.TableOld,
    style: {
      gridTemplateColumns: "repeat(" + columnCount + ", auto)"
    }
  }, /*#__PURE__*/React__default['default'].createElement(TableHeader, null), /*#__PURE__*/React__default['default'].createElement(TableBody, null)));
};
...
var TableOld = function TableOld(props) {
  ...
  return (
    ...
    React__default['default'].createElement(DataUrl.Boundaries, null, data ? data.length > 0 ?
    /*#__PURE__*/
    ...
    React__default['default'].createElement(TableBaseOld, props) :
    /*#__PURE__*/
    // This is a temporary empty style.
    React__default['default'].createElement(TemporaryEmpty, null) :
    /*#__PURE__*/
    // This is a temporary loading style. We will eventually define a loading style using the shape of modules.
    React__default['default'].createElement(TemporaryLoading, null))
  );
};
...
var propTypes$2 = {
  content: pt__default$1['default'].oneOfType([pt__default$1['default'].arrayOf(pt__default$1['default'].node), pt__default$1['default'].node]),
  // eslint-disable-next-line react/forbid-prop-types -- This is a Reakit state object
  tabState: pt__default$1['default'].object.isRequired
};
...
var Tab = function Tab(_ref) {
  ...
  var thisTab = React.useRef(null);
  return /*#__PURE__*/React__default['default'].createElement(Tab$1.Tab, _extends__default['default']({
    className: classNames__default$1['default']('item', {
...
var TabPanel = function TabPanel(_ref) {
  ...
  var content = _ref.content,
      tabState = _ref.tabState;
  var thisPanel = React.useRef(null); // We use this to conditionally render the contents of the Tab so that we are
  ...
  return /*#__PURE__*/React__default['default'].createElement(Tab$1.TabPanel, _extends__default['default']({
...
var TAB_FALLBACK = /*#__PURE__*/React__default['default'].createElement("div", {
  className: "ui bottom attached loading tab segment"
});
var propTypes = {
  /** An array of objects used to tell Tabs what to display. */
  tabs: pt__default$1['default'].arrayOf(pt__default$1['default'].shape({
...
var Tabs = function Tabs(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Tab$1.TabList, _extends__default['default']({
  ...
  }, title), /*#__PURE__*/React__default['default'].createElement(DataUrl.Boundaries, null, tabs === null || tabs === void 0 ? void 0 : tabs.map(function (_ref2) {
    var label = _ref2.label;
...
exports.Boundaries = DataUrl.Boundaries;
exports.Button = DataUrl.Button;
exports.ActionStack = ActionStack;
exports.AdminStructure = AdminStructure;
exports.AreaPlaceholder = AreaPlaceholder;
exports.BaristaStructure = BaristaStructure;
...
exports.Tabs = Tabs;
exports.Title = Title;
exports.formOldPropTypes = propTypes$e;
exports.paginationPropTypes = propTypes$b;
exports.tableOldPropTypes = TABLE_SHAPE;
