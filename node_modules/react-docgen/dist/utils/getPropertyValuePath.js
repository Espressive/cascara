...
function getPropertyValuePath(path, propertyName, importer) {
  ...
  return path.get('properties').filter(propertyPath => (0, _getPropertyName.default)(propertyPath, importer) === propertyName).map(propertyPath => propertyPath.get('value'))[0];
}