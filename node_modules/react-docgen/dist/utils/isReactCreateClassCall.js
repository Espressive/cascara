...
function isReactCreateClassCallModular(path, importer) {
  ...
  const module = (0, _resolveToModule.default)(path, importer);
...
function isReactCreateClassCall(path, importer) {
  return (0, _isReactBuiltinCall.default)(path, 'createClass', importer) || isReactCreateClassCallModular(path, importer);
}