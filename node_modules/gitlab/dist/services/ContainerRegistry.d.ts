...
declare class ContainerRegistry extends BaseService {
    ...
    removeTag(projectId: ProjectId, repositoryId: number, tagName: string, options?: Sudo): Promise<object>;
    removeTags(projectId: ProjectId, repositoryId: number, tagNameRegex: string, options?: Sudo & {
        keepN: string;
        olderThan: string;
    }): Promise<object>;
