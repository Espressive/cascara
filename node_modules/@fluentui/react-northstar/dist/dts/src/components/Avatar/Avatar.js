...
var AvatarLabel_1 = require("./AvatarLabel");
...
var Avatar = function (props) {
    ...
    var imageElement = utils_1.createShorthand(AvatarImage_1.AvatarImage, image, {
    ...
    var iconElement = utils_1.createShorthand(AvatarIcon_1.AvatarIcon, icon, {
        defaultProps: function () {
    ...
    var labelElement = utils_1.createShorthand(AvatarLabel_1.AvatarLabel, label || {}, {
        defaultProps: function () {
    ...
    var result = (React.createElement(ElementType, tslib_1.__assign({}, getA11Props('root', tslib_1.__assign({ className: classes.root }, unhandledProps))),
        ...
        utils_1.createShorthand(AvatarStatus_1.AvatarStatus, status, {
            defaultProps: function () {
