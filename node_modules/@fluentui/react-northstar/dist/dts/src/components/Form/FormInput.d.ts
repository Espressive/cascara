 ...
 */
export declare const FormInput: import("@fluentui/react-bindings").ComponentWithAs<"input", FormInputProps & Pick<FormFieldBaseProps, "className" | "message" | "inline" | "errorMessage">>;
export {};
