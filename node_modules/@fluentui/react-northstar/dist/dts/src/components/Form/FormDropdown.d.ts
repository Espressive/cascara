 ...
 */
export declare const FormDropdown: import("@fluentui/react-bindings").ComponentWithAs<"div", DropdownProps & Pick<FormFieldBaseProps, "label" | "className" | "message" | "inline" | "errorMessage">>;
export {};
