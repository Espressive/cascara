...
export declare type FormDatepickerStylesProps = never;
export declare const formDatepickerClassName = "ui-form__datepicker";
/**
 * An FormDatepicker renders a Datepicker wrapped by FormField.
 */
export declare const FormDatepicker: import("@fluentui/react-bindings").ComponentWithAs<"div", FormDatepickerProps & Pick<FormFieldBaseProps, "label" | "className" | "message" | "inline" | "errorMessage">>;
export {};
