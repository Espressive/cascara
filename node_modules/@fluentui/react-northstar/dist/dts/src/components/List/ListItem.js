...
var ListItem = function (props) {
    ...
    var parentProps = react_bindings_1.useContextSelectors(listContext_1.ListContext, {
    ...
    var classes = react_bindings_1.useStyles(exports.ListItem.displayName, {
    ...
    var contentElement = utils_1.createShorthand(ListItemContent_1.ListItemContent, content, {
    ...
    var contentMediaElement = utils_1.createShorthand(ListItemContentMedia_1.ListItemContentMedia, contentMedia);
    var headerElement = utils_1.createShorthand(ListItemHeader_1.ListItemHeader, header, {
        defaultProps: function () { return ({
            hasContent: !!content,
    ...
    var headerMediaElement = utils_1.createShorthand(ListItemHeaderMedia_1.ListItemHeaderMedia, headerMedia);
    var endMediaElement = utils_1.createShorthand(ListItemEndMedia_1.ListItemEndMedia, endMedia, {
        defaultProps: function () { return ({
            navigable: navigable,
            selectable: selectable,
        }); },
    });
    var mediaElement = utils_1.createShorthand(ListItemMedia_1.ListItemMedia, media, {
        defaultProps: function () { return ({
            hasContent: !!content,
            hasHeader: !!header,
            important: important,
