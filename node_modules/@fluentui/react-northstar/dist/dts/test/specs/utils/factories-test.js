...
var itAppliesDefaultProps = function (value) {
    test('applies defaultProps', function () {
        ...
        var expectedResult = isValuePrimitive(value) ? tslib_1.__assign(tslib_1.__assign({}, defaultPropsValue), { children: value }) : defaultPropsValue;
    ...
    describe('createShorthand', function () {
        ...
        describe('styles', function () {
            test('deep merges styles prop onto defaultProps styles', function () {
                ...
                utils_2.consoleUtil.disableOnce();
                getShorthand({
                    value: tslib_1.__assign(tslib_1.__assign({}, props), { children: function (Component, props) {
        ...
        describe('defaultProps', function () {
            test('can be an object', function () {
                ...
                testCreateShorthand({ defaultProps: function () { return defaultPropsValue; }, value: 'foo' }, tslib_1.__assign(tslib_1.__assign({}, defaultPropsValue), { children: 'foo' }));
            });
        ...
        describe('overrideProps', function () {
            ...
            test('can be an object', function () {
                ...
                testCreateShorthand({ overrideProps: overrideProps, value: testValue }, tslib_1.__assign(tslib_1.__assign({}, overrideProps), { children: testValue }));
            });
