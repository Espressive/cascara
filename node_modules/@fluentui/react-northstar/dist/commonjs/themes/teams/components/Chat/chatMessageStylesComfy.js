...
exports.chatMessageStylesComfy = void 0;
...
var chatMessageStylesComfy = {
  ...
  badge: function badge(_ref7) {
    ...
    var p = _ref7.props;
    return _ref8 = {}, _ref8[p.badgePosition === 'start' ? 'left' : 'right'] = 0, _ref8.transform = p.badgePosition === 'start' ? 'translateX(-50%)' : 'translateX(50%)', _ref8.top = (0, _utils.pxToRem)(4), _ref8.position = 'absolute', _ref8;
  },
...
exports.chatMessageStylesComfy = chatMessageStylesComfy;
