...
var chatItemStyles = {
  root: function root(_ref) {
    ...
    return Object.assign({
      ...
      paddingTop: p.density === 'compact' ? (0, _utils.pxToRem)(8) : (0, _utils.pxToRem)(16)
    }, (p.attached === 'bottom' || p.attached === true) && {
      paddingTop: p.density === 'compact' ? 0 : (0, _utils.pxToRem)(2)
    }, {
      paddingBottom: 0
    }, p.density === 'compact' && {
  ...
  gutter: function gutter(_ref2) {
    ...
    }, _Object$assign[p.contentPosition === 'end' ? 'right' : 'left'] = p.density === 'compact' ? (0, _utils.pxToRem)(28) : 0, _Object$assign), (p.attached === 'bottom' || p.attached === true) && {
      display: 'none'
    });
  },
