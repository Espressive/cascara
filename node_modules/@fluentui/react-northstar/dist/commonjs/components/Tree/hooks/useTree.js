...
function useTree(options) {
  ...
  var _React$useMemo = React.useMemo(function () {
    return (0, _flattenTree.flattenTree)(options.items, activeItemIds, selectedItemIds);
  ...
  var toggleItemActive = React.useCallback(function (e, idToToggle) {
    ...
    setActiveItemIdsState(function (activeItemIds) {
      ...
      if (isActiveId) {
        nextActiveItemIds = (0, _without2.default)(activeItemIds, idToToggle);
      } else {
        ...
        if (options.exclusive) {
          ...
          if (activeSibling != null) {
            nextActiveItemIds = (0, _without2.default)(nextActiveItemIds, activeSibling);
          }
        }
      }
  ...
  var expandSiblings = React.useCallback(function (e, focusedItemId) {
    ...
    setActiveItemIdsState(function (activeItemIds) {
      var nextActiveItemIds = (0, _uniq2.default)(activeItemIds.concat(siblingsIds));
      (0, _invoke2.default)(stableProps.current, 'onActiveItemIdsChange', e, Object.assign({}, stableProps.current, {
        activeItemIds: nextActiveItemIds
      }));
      return nextActiveItemIds;
  ...
  var toggleItemSelect = React.useCallback(function (e, idToToggle) {
    ...
    setSelectedItemIdsState(function (selectedItemIds) {
      var nextSelectedItemIds = item.selected === true ? _without2.default.apply(void 0, [selectedItemIds].concat(leafs)) // remove all leaves from selected
      : (0, _uniq2.default)(selectedItemIds.concat(leafs)); // add all leaves to selected
