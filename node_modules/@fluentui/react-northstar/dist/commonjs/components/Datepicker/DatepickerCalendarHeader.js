...
var DatepickerCalendarHeader = function DatepickerCalendarHeader(props) {
  ...
  }, unhandledProps)), (0, _utils.createShorthand)(_Text.Text, label, {
    defaultProps: function defaultProps() {
      return getA11yProps('label', {
        className: classes.label
      });
    }
  }), (0, _utils.createShorthand)(_DatepickerCalendarHeaderAction.DatepickerCalendarHeaderAction, previousButton, {
    defaultProps: function defaultProps() {
...
DatepickerCalendarHeader.defaultProps = {
  ...
  previousButton: {},
  label: {},
  prevMonthAriaLabel: _dateTimeUtilities.DEFAULT_CALENDAR_STRINGS.prevMonthAriaLabel,
  nextMonthAriaLabel: _dateTimeUtilities.DEFAULT_CALENDAR_STRINGS.nextMonthAriaLabel
};
