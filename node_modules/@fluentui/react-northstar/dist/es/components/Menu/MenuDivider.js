...
import { getElementType, mergeVariablesOverrides, useFluentContext, useAccessibility, useTelemetry, useStyles, useUnhandledProps, useContextSelectors } from '@fluentui/react-bindings';
...
export var MenuDivider = /*#__PURE__*/function () {
  var MenuDivider = /*#__PURE__*/React.forwardRef(function (inputProps, ref) {
    ...
    var _useTelemetry = useTelemetry(MenuDivider.displayName, context.telemetry),
    ...
    var _useStyles = useStyles(MenuDivider.displayName, {
    ...
    var unhandledProps = useUnhandledProps(MenuDivider.handledProps, props);
