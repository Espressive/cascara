 ...
 */
export declare const FormSlider: import("@fluentui/react-bindings").ComponentWithAs<"div", FormSliderProps & Pick<FormFieldBaseProps, "label" | "className" | "message" | "inline" | "errorMessage">>;
export {};
