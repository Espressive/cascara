 ...
 */
export declare const FormTextArea: import("@fluentui/react-bindings").ComponentWithAs<"textarea", FormTextAreaProps & Pick<FormFieldBaseProps, "label" | "className" | "message" | "inline" | "errorMessage">>;
export {};
