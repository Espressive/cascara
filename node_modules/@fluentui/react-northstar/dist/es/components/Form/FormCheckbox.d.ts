 ...
 */
export declare const FormCheckbox: import("@fluentui/react-bindings").ComponentWithAs<"div", FormCheckboxProps & Pick<FormFieldBaseProps, "className" | "message" | "inline" | "errorMessage">>;
export {};
