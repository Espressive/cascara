 ...
 */
export declare const FormButton: import("@fluentui/react-bindings").ComponentWithAs<"div", FormButtonProps & Pick<FormFieldBaseProps, "label" | "className" | "message" | "inline" | "errorMessage">>;
export {};
