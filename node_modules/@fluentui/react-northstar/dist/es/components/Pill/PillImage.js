...
export var pillImageClassName = 'ui-pill__image';
/**
 * An PillImage is a graphic representation used by Pill.
 */

export var PillImage = /*#__PURE__*/function () {
  var PillImage = function PillImage(props) {
    var context = useFluentContext();

    var _useTelemetry = useTelemetry(PillImage.displayName, context.telemetry),
    ...
    var _useStyles = useStyles(PillImage.displayName, {
    ...
    var unhandledProps = useUnhandledProps(PillImage.handledProps, props);
  ...
  PillImage.propTypes = Object.assign({}, commonPropTypes.createCommon({
    children: false,
    content: false
  }));
