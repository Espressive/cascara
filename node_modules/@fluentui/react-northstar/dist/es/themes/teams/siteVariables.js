...
export var shadow16 = '0 0 2px rgba(0, 0, 0, .12), 0 6px 16px rgba(0, 0, 0, .14)';
export var shadow28 = '0 0 8px rgba(0, 0, 0, .12), 0 14px 28px rgba(0, 0, 0, .14)';
export var shadow64 = '0 0 8px rgba(0, 0, 0, .12), 0 32px 64px rgba(0, 0, 0, .14)'; //
// FONT SIZES
//
