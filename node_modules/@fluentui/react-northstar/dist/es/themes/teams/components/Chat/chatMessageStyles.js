...
export var chatMessageStyles = {
  root: function root(componentStyleFunctionParam) {
    ...
    }, p.showActionMenu && (_ref = {}, _ref["> ." + chatMessageSlotClassNames.actionMenu] = displayActionMenu(v.overlayZIndex), _ref)), (_getChatMessageDensit = (_getChatMessageDensit2 = getChatMessageDensityStyles(p.density)).root) == null ? void 0 : _getChatMessageDensit.call(_getChatMessageDensit2, componentStyleFunctionParam));
  },
