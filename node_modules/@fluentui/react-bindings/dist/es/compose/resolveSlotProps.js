...
import { defaultMappedProps } from './consts';
import { mergeSlotProp } from './mergeSlotProp';
export var NullRender = function NullRender() {
  return null;
};
/**
    ...
    if (slot && slotProp !== undefined && slotProp !== null) {
      ...
      if (typeof mergedSlotProp.children === 'function') {
        var children = slotProp.children,
            restProps = _objectWithoutPropertiesLoose(slotProp, ["children"]); // If the children is a function, replace the slot.
