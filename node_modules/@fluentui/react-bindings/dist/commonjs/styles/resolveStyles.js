...
var resolveStyles = function resolveStyles(options, resolvedVariables) {
  ...
  if (allDisplayNames.length === 1) {
    ...
    if (_styles.length > 0) {
      mergedStyles = _styles.reduce(function (acc, styles) {
        return (0, _styles2.mergeComponentStyles)(acc, styles);
      }, {});
    } else {
      mergedStyles = {
        root: function root() {
  ...
  if (!noInlineStylesOverrides) {
    mergedStyles = (0, _styles2.mergeComponentStyles)(mergedStyles, (0, _styles2.mergeComponentStyles)(design && (0, _styles2.withDebugId)({
      root: design
      ...
      Object.defineProperty(_classes, slotName, {
        ...
        get: function get() {
          ...
          if (_classes[lazyEvaluationKey]) {
            return slotName === 'root' ? (0, _classnames.default)(componentClassName, _classes[lazyEvaluationKey], className) : _classes[lazyEvaluationKey];
          ...
          var resultClassName = slotName === 'root' ? (0, _classnames.default)(componentClassName, _classes[lazyEvaluationKey], className) : _classes[lazyEvaluationKey];
  ...
  var classes = new Proxy({}, {
    get: function get(target, slotName) {
      ...
      if (target[slotName]) {
        return slotName === 'root' ? (0, _classnames.default)(componentClassName, target[slotName], className) : target[slotName];
      } // this resolves the getter magic
      ...
      var resultClassName = slotName === 'root' ? (0, _classnames.default)(componentClassName, target[slotName], className) : target[slotName];
