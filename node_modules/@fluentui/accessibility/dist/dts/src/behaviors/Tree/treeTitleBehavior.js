...
var treeTitleBehavior = function (props) {
    ...
    var definition = {
        attributes: {
            root: tslib_1.__assign({}, (!props.hasSubtree && tslib_1.__assign((_a = { tabIndex: -1 }, _a[attributes_1.IS_FOCUSABLE_ATTRIBUTE] = true, _a.role = 'treeitem', _a['aria-setsize'] = props.treeSize, _a['aria-posinset'] = props.index, _a['aria-level'] = props.level, _a), (props.selectable && { 'aria-checked': props.selected })))),
        },
        keyActions: {
            root: {
                performClick: {
                    keyCombinations: props.selectable
                        ? [{ keyCode: keyboard_key_1.SpacebarKey }]
                        : [{ keyCode: keyboard_key_1.SpacebarKey }, { keyCode: keyboard_key_1.EnterKey }],
                },
                focusParent: {
