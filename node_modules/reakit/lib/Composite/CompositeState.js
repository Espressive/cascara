...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case "setVirtual":
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
        unstable_virtual: misc.applyState(action.virtual, virtual)
      });

    case "setRTL":
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
        rtl: misc.applyState(action.rtl, rtl)
      });

    case "setOrientation":
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
        orientation: misc.applyState(action.orientation, orientation)
      });
    ...
    case "setCurrentId":
      {
        var nextCurrentId = getCurrentId.getCurrentId(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
          currentId: misc.applyState(action.currentId, currentId)
        }));
        return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
    ...
    case "setLoop":
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
        loop: misc.applyState(action.loop, loop)
      });

    case "setWrap":
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
        wrap: misc.applyState(action.wrap, wrap)
      });

    case "setShift":
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
        shift: misc.applyState(action.shift, shift)
      });

    case "setIncludesBaseElement":
      {
        return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
          unstable_includesBaseElement: misc.applyState(action.includesBaseElement, includesBaseElement)
        });
      }
...
function useCompositeState(initialState) {
  ...
  var _useInitialValue = hooks.useInitialValue(initialState),
      _useInitialValue$unst = _useInitialValue.unstable_virtual,
      virtual = _useInitialValue$unst === void 0 ? false : _useInitialValue$unst,
      _useInitialValue$rtl = _useInitialValue.rtl,
      rtl = _useInitialValue$rtl === void 0 ? false : _useInitialValue$rtl,
      orientation = _useInitialValue.orientation,
      currentId = _useInitialValue.currentId,
      _useInitialValue$loop = _useInitialValue.loop,
      loop = _useInitialValue$loop === void 0 ? false : _useInitialValue$loop,
      _useInitialValue$wrap = _useInitialValue.wrap,
      wrap = _useInitialValue$wrap === void 0 ? false : _useInitialValue$wrap,
      _useInitialValue$shif = _useInitialValue.shift,
      shift = _useInitialValue$shif === void 0 ? false : _useInitialValue$shif,
      unstable_includesBaseElement = _useInitialValue.unstable_includesBaseElement,
      sealed = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_useInitialValue, ["unstable_virtual", "rtl", "orientation", "currentId", "loop", "wrap", "shift", "unstable_includesBaseElement"]);
