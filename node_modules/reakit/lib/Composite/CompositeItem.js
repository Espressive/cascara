...
var setTextFieldValue = require('../setTextFieldValue-a581194e.js');
...
var useCompositeItem = createHook.createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    var isCurrentItemRef = hooks.useLiveRef(isCurrentItem);
    var hasFocusedComposite = React.useRef(false);
    var item = useItem(options);
    var onMouseDownRef = hooks.useLiveRef(htmlOnMouseDown);
    var onFocusRef = hooks.useLiveRef(htmlOnFocus);
    var onBlurCaptureRef = hooks.useLiveRef(htmlOnBlurCapture);
    var onKeyDownRef = hooks.useLiveRef(htmlOnKeyDown);
    var onClickRef = hooks.useLiveRef(htmlOnClick);
    ...
    var onFocus = React.useCallback(function (event) {
      ...
      if (shouldFocusComposite && options.unstable_virtual && options.baseId && events.isSelfTarget(event)) {
        var target = event.target;
        var composite = dom.getDocument(target).getElementById(options.baseId);
    ...
    var onKeyDown = React.useCallback(function (event) {
      ...
      if (event.key.length === 1 && event.key !== " ") {
        ...
        if (widget && dom.isTextField(widget)) {
          widget.focus();
        ...
        if (_widget && dom.isTextField(_widget)) {
          event.preventDefault();
    ...
    var onClick = React.useCallback(function (event) {
      ...
      if (widget && !focus.hasFocusWithin(widget)) {
    ...
    return _rollupPluginBabelHelpers._objectSpread2({
      ref: hooks.useForkRef(ref, htmlRef),
      id: id,
