...
var unstable_useCombobox = createHook.createHook({
  ...
  useProps: function useProps(options, _ref2) {
    ...
    var onKeyPressRef = hooks.useLiveRef(htmlOnKeyPress);
    var onChangeRef = hooks.useLiveRef(htmlOnChange);
    ...
    return _rollupPluginBabelHelpers._objectSpread2({
      ref: hooks.useForkRef(ref, hooks.useForkRef(options.unstable_referenceRef, htmlRef)),
      role: "combobox",
      autoComplete: "off",
  ...
  useComposeProps: function useComposeProps(options, _ref3) {
    ...
    var onKeyDownCaptureRef = hooks.useLiveRef(htmlOnKeyDownCapture);
    var onKeyDownRef = hooks.useLiveRef(htmlOnKeyDown);
