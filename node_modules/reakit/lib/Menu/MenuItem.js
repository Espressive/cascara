...
require('../Id/Id.js');
require('../setTextFieldValue-a581194e.js');
...
function useTransitToSubmenu(menu, htmlOnMouseEnter) {
  var onMouseEnterRef = hooks.useLiveRef(htmlOnMouseEnter);
...
function hoveringExpandedMenu(event, children) {
  ...
  return visibleSubmenu && dom.contains(visibleSubmenu, nextElement);
}
...
function hoveringAnotherMenuItem(event, items) {
  ...
  return items === null || items === void 0 ? void 0 : items.some(function (item) {
    return item.ref.current && dom.contains(item.ref.current, nextElement);
  });
}
...
var useMenuItem = createHook.createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    var onMouseMoveRef = hooks.useLiveRef(htmlOnMouseMove);
    var onMouseLeaveRef = hooks.useLiveRef(htmlOnMouseLeave);
    ...
    var onMouseMove = React.useCallback(function (event) {
      ...
      if (focus.hasFocusWithin(event.currentTarget)) return;
