...
var useTooltip = createHook.createHook({
  ...
  useProps: function useProps(options, _ref2) {
    ...
    React.useEffect(function () {
      ...
      var document = dom.getDocument((_options$unstable_pop = options.unstable_popoverRef) === null || _options$unstable_pop === void 0 ? void 0 : _options$unstable_pop.current);
    ...
    return _rollupPluginBabelHelpers._objectSpread2({
      ref: hooks.useForkRef(options.unstable_popoverRef, htmlRef),
      role: "tooltip",
