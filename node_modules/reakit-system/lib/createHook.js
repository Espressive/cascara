...
function createHook(options) {
  ...
  var composedHooks = misc.toArray(options.compose);
  ...
  useHook.unstable_propsAreEqual = options.propsAreEqual || ((_composedHooks$ = composedHooks[0]) === null || _composedHooks$ === void 0 ? void 0 : _composedHooks$.unstable_propsAreEqual) || misc.shallowEqual;
