...
function hideFixtureSuffix(treeNode, suffix) {
  ...
  return _objectSpread(_objectSpread({}, treeNode), {}, {
    children: Object.keys(children).reduce(function (newChildren, childName) {
      ...
      if (childNode.data.type === 'fileDir') return _objectSpread(_objectSpread({}, newChildren), {}, _defineProperty({}, childName, hideFixtureSuffix(childNode, suffix)));
      var cleanFixtureName = removeFixtureNameSuffix(childName, suffix);
      return _objectSpread(_objectSpread({}, newChildren), {}, _defineProperty({}, cleanFixtureName, hideFixtureSuffix(childNode, suffix)));
    }, {})
  });
}
