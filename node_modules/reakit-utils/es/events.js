import { contains, getDocument, getWindow, getActiveElement, canUseDOM } from './dom.js';
...
function getNextActiveElementOnBlur(event) {
  var isIE11 = canUseDOM && "msCrypto" in window; // IE 11 doesn't support event.relatedTarget on blur.
...
export { createEvent, fireBlurEvent, fireEvent, fireKeyboardEvent, getNextActiveElementOnBlur, isPortalEvent, isSelfTarget };
