import { canUseDOM, getNativeElementType } from './dom.js';
...
function useNativeElementType(ref, defaultType) {
  var _useState2 = useState(function () {
    return getNativeElementType(null, defaultType);
  }),
      type = _useState2[0],
...
export { useEventCallback, useForkRef, useInitialValue, useLazyRef, useLiveRef, useNativeElementType, useSafeLayoutEffect, useUpdateEffect };
