                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.performAPI(this.oauthURL, __assign(__assign({}, headers), { Authorization: "Basic " + new Buffer(this.credentials.oauthKey + ":" + this.credentials.oauthSecret).toString("base64"), "Content-Type": "application/x-www-form-urlencoded" }), params, "POST", suppressErrors)];
                        case 2:
