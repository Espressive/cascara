...
exports.jsonDSLGenerator = void 0;
var GitHubGit_1 = require("../platforms/github/GitHubGit");
exports.jsonDSLGenerator = function (platform, source, program) { return __awaiter(void 0, void 0, void 0, function () {
    var useSimpleDSL, git, _a, getDSLFunc, platformDSL, cliArgs, dslPlatformName;
    var _b;
        ...
        switch (_c.label) {
            ...
            case 4:
                ...
                return [2 /*return*/, (_b = {
                        ...
                        _b[dslPlatformName] = platformDSL,
                        _b.settings = {
                            github: {
