        ...
        module = {
          ...
          get: {
            ...
            transform: {
              ...
              over: function() {
                const
                    translate = {x: -(($activeSide.outerWidth(true) - $nextSide.outerWidth(true)) / 2)}
              ;
          ...
          stage: {
            ...
            ;
              ...
              $sides
                .css({'transform': 'translateZ(-' + box.depth.active + 'px)'})
              ;
              $activeSide
                .css({'transform': 'rotateY(0deg) translateZ(' + box.depth.active + 'px)'})
              ;
              $nextSide
                .addClass(className.animating)
                .css({
